...
extend(Chart.prototype, {
	...
	sanitizeSVG: function (svg, options) {
	    ...
	    svg = svg
            ...
            //This line cause of fail export from Dashboard
            //.replace(/url\([^#]+#/g, 'url(#')
	...
	addButton: function (options) {
		...
		if (!chart.buttonOffset) {
		    chart.buttonOffset = 0;
		}
		if (!chart.options.navigation.buttonOptions.prevAlignState) {
		    chart.options.navigation.buttonOptions.prevAlignState = btnOptions.align;
		}
		if (!chart.options.navigation.buttonOptions.prevVerticalAlignState) {
		    chart.options.navigation.buttonOptions.prevVerticalAlignState = btnOptions.verticalAlign;
		}
		if (btnOptions.align !== chart.options.navigation.buttonOptions.prevAlignState ||
            btnOptions.verticalAlign !== chart.options.navigation.buttonOptions.prevVerticalAlignState) {
		    chart.buttonOffset = 0;
		}
		...
		button.add()
			.align(extend(btnOptions, {
				width: button.width,
				x: Highcharts.pick(btnOptions.x, chart.buttonOffset) // #1654
			}), true, 'spacingBox');
...
symbols.exportIcon = function (a, b, c, d) { return ["M", a, b + c, "L", a + c, b + d, a + c, b + d * 0.8, a, b + d * 0.8, "Z", "M", a + c * 0.5, b + d * 0.8, "L", a + c * 0.8, b + d * 0.4, a + c * 0.4, b + d * 0.4, a + c * 0.4, b, a + c * 0.6, b, a + c * 0.6, b + d * 0.4, a + c * 0.2, b + d * 0.4, "Z"] };  
