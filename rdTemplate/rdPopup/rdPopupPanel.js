...
function rdPositionPopupPanel(elePopupPanel){
    ...
    switch (sLocation.toLowerCase()) {
        ...
        case 'mouse':
            ...
            nParentOffsetLeft = rdFindPosX(elePopupPanel.offsetParent);
            nParentOffsetTop = rdFindPosY(elePopupPanel.offsetParent);
            ...
            // Cannot run this code path for Mobile in studio as the browser is IE at this time.
                ...
                if ((nTop + regionPopupPanel.height + 10) > regionViewport.bottom) {
                   nTop = regionViewport.bottom - regionPopupPanel.height - 10;
                   if (nTop < regionViewport.top) {
                       nTop = regionViewport.top
                   }
                }
                else
                    nTop += 4
                if((nLeft + regionPopupPanel.width + 10) > regionViewport.right){
