...
function rdCheckForAPopupPanelParent(eleHTMLIFrameElement) {
    try {
        ...
        while (eleParentObj) {
            if (Y.Lang.isValue(eleParentObj.attributes) && eleParentObj.attributes["rdPopupPanel"] && eleParentObj.attributes["rdLocation"] && eleParentObj.attributes["rdLocation"]=="Center") {
