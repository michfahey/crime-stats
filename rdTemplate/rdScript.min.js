...
*/
function GetColorPicker(e,t){sColorPicker=e,eleParamsPopup=Y.Selector.ancestor(t,"[rdpopuppanel=True]",!1),elePanel=Y.one("#"+eleParamsPopup.id.replace("ppPanelParams-","rdDashboardPanel-")),sPanelInstanceId=elePanel.get("id").substring(elePanel.get("id").lastIndexOf("_")+1)}function PickGaugeGoalColor(e){var t=Y.Color.toHex(Y.one("#"+e.id).getComputedStyle("backgroundColor")),n=document.getElementById("rdAgGaugeGoalsColor"+sColorPicker+"_"+sPanelInstanceId);n.value=t;var r=Y.Selector.query("#rectColor"+sColorPicker,eleParamsPopup,!0);r.style.backgroundColor=t,ShowElement(this.id,"ppColors","Hide")}function rdSaveEditedAgViz(e,t,n,r,i){var s="popupEditAgViz_"+n,o="ShowElement(this.id, '"+s+"', 'Hide', '')";window.parent.eval(o);var u="&rdDashboardEditVizType="+t;u+="&rdReport="+rdAjaxEncodeValue(e),u+="&rdDefInDataCache=True",u+="&PanelID="+n,u+="&PanelInstanceID="+r;switch(t){case"AnalysisChart":u+="&rdPanelContentElementID=rdDashboardEditAc";break;case"AxTable":u+="&rdPanelContentElementID=rdDashboardEditAx";break;case"AgTable":u+="&rdPanelContentElementID=rdDashboardEditAgTable"}u+="&rdBookmarkID="+i;var a="rdAjaxRequestWithFormVars('rdAjaxCommand=rdAjaxNotify&rdNotifyCommand=SaveEditedAgViz"+u+"');";window.parent.eval(a),window.parent.eval("rdShowWaitPanel(['', '', '', '0'])")}function rdDbSetGlobalFilterFromChart(e,t,n,r){var i="rdGlobalAf_"+document.getElementById("ActiveTabIdentifier").value;switch(t){case"Categorized":var s=document.getElementById("rdFilteredXAxis_"+e),o=s.value;rdAfSetGlobalFilter(!0,i,e,n,o,"In List");break;case"Date Range":var s=document.getElementById("rdFilteredXAxis_"+e),u=s.value.split(","),a=u[0],f=u[u.length-1];rdAfSetGlobalFilter(!0,i,e,n,a+"|"+f,"Date Range");break;case"LinearX":case"LinearDate":var l=document.getElementById("rdFilteredXAxisMin_"+e),c=document.getElementById("rdFilteredXAxisMax_"+e);if(l&&c){var a=l.value,f=c.value,h="Range";t=="LinearDate"&&(h="Date Range"),rdAfSetGlobalFilter(!0,i,e,n,a+"|"+f,h)}break;case"LinearXY":var l=document.getElementById("rdFilteredXAxisMin_"+e),c=document.getElementById("rdFilteredXAxisMax_"+e);if(l&&c){var a=l.value,f=c.value,p="Range";a.indexOf("T")==10&&(p="Date Range"),rdAfSetGlobalFilter(!0,i,e,n,a+"|"+f,p)}l=document.getElementById("rdFilteredYAxisMin_"+e),c=document.getElementById("rdFilteredYAxisMax_"+e);if(l&&c){var a=l.value,f=c.value;setTimeout(function(){rdAfSetGlobalFilter(!0,i,e,r,a+"|"+f,"Range")},1)}}}function rdDbEnableGlobalFilterHighlighting(){var e=document.getElementById("rdGlobalFilterCaption"),t,n;e&&(t=e.parentNode.getElementsByTagName("SPAN"),n=e.innerText.split(","));var r=!1,i=Y.all("span[id^='lblFilterDataColumn_rdGlobalAf']"),s=Y.all("span[id^='lblFilterCaption_rdGlobalAf']"),o=Y.all("input[id^='rdAfFilterDisabled_rdGlobalAf']"),u=0;for(var a=0;a<i.size();a++){var f=i.item(a)._node,l=f.innerText,c=document.getElementById(f.id.replace("lblFilterDataColumn_","lblFilterDashboardPanelID_")),h=c.innerText,p=s.item(a)._node;p.setAttribute("rdFilterColumn",l),p.setAttribute("rdFilterPanelID",h),p.onmouseover=function(){rdDbHighlightFilteredPanel(this)},p.onmouseout=function(){rdDbUnHighlightFilteredPanels(this)},r=rdDoesSpanExist(p.innerText,t);var d;o&&o.item(a)&&(d=o.item(a)._node,d&&!d.checked&&(r=!0));if(r==0){var v="";if(u>0){var m=e.parentNode.appendChild(document.createElement("SPAN"));m.innerText=", ",n&&n[a]&&(v=n[a].substring(0,n[a].indexOf("[")),m.innerText+=v)}var p=e.parentNode.appendChild(document.createElement("SPAN")),g=i.item(a).get("parentNode").all("span[id^='lblFilterCaption_rdGlobalAf']").item(0)._node.innerText;p.innerText=g,p.setAttribute("rdFilterColumn",l),p.setAttribute("rdFilterPanelID",h),p.onmouseover=function(){rdDbHighlightFilteredPanel(this)},p.onmouseout=function(){rdDbUnHighlightFilteredPanels(this)};var y=Y.all("div[id^='rdDashboardPanel-']");for(var b=0;b<y.size();b++){var w=y.item(b)._node,E=y.item(b).one("span[class='rdGlobalFilterColumnIDsClass']");if(E){E=E._node;var S=E.innerText,x=S.split(",");if(x.indexOf(l)!=-1)if(h==""||w.id.indexOf(h)==-1){var T=document.getElementById("rdPanelGlobalFilterCaption_"+Y.LogiInfo.Dashboard.prototype.rdGetPanelInstanceId(w)),N="";T.innerText.length>0&&(N=", "),T.innerText+=N+v+g,T.parentNode.parentNode.style.display=""}}}u+=1}r=!1}e&&setTimeout(function(){e.innerText=""},1)}function rdDoesSpanExist(e,t){for(var n=0;n<t.length;n++){if(t[n].getAttribute("id")=="rdGlobalFilterCaption")continue;var r=t[n].getAttribute("innerText"),i=t[n].innerText;if(r==e)return!0;if(i&&i==e)return!0}return!1}function rdDbHighlightFilteredPanel(e){e.style.transition="border-color 0.2s",e.className="rdDashboardCaptionGlobalFiltered";var t=e.getAttribute("rdFilterColumn"),n=e.getAttribute("rdFilterPanelID"),r=Y.all("div[id^='rdDashboardPanel-']");for(var i=0;i<r.size();i++){var s=r.item(i)._node,o=r.item(i).one("span[class='rdGlobalFilterColumnIDsClass']");if(o){o=o._node;var u=o.innerText,a=u.split(",");a.indexOf(t)!=-1&&(n==""||s.id.indexOf(n)==-1)&&(s.style.transition="border-color 0.2s",s.className+=" rdDashboardPanelGlobalFiltered")}}}function rdDbUnHighlightFilteredPanels(e){e.className="";var t=Y.all("div[id^='rdDashboardPanel-']");for(var n=0;n<t.size();n++){var r=t.item(n)._node;r.className=r.className.replace(" rdDashboardPanelGlobalFiltered","")}}var rdNewPanelCnt=0;YUI.add("dashboard",function(e){var t=e.LogiXML.Dashboard.FreeForm;e.namespace("LogiInfo").Dashboard=e.Base.create("Dashboard",e.Base,[],{initializer:function(n){var r=document.getElementById("rdDashboardAdjustable"),i=document.getElementById("rdFreeformLayout");i!=null&&i.id.toLowerCase()=="rdhiddenrequestforwarding"&&(i=null),i!=null&&this.set("bIsFreeformLayout",!0);if(!r)return;rdDbEnableGlobalFilterHighlighting();if(r.innerHTML=="False"){this.set("bDashboardAdjustable",!1);var s="rdDashboardPanel";this.get("bIsFreeformLayout")&&(this.rdSizeUnAdjustablePanels(s),t.rdResizeDashboardContainer())}if(r.innerHTML!="False"){LogiXML.Ajax.AjaxTarget&&LogiXML.Ajax.AjaxTarget().on("reinitialize",function(){rdSetUndoRedoVisibility()},this),rdSetUndoRedoVisibility();var o;if(typeof rdMobileReport=="undefined"){var u=e.all("div.rdDashboardPanel"),a=u.size();a>0&&t.addPanelClickEvents();for(o=0;o<a;o++)e.DD.DDM.getNode(u.item(o)).destroy();for(o=0;o<a;o++){var f=u.item(o).getDOMNode();if(f.className.indexOf("yui-resize")!=-1||f.id.indexOf("rdDashboardPanel-")!=0)continue;var l=f.id.replace("rdDashboardPanel-","rdDashboardPanelTitle-"),c=e.one(f),h=new e.DD.Drag({node:c});c.addClass("dragHandleOnly"),this.get("bIsFreeformLayout")&&h.plug(e.Plugin.DDConstrained,{tickX:10,tickY:10,constrain:[]});var p,d=c.all("div");for(var v=0;v<d.size();v++)if(d.item(v).get("id").indexOf("rdDashboard2PanelContent_")==0){p=d.item(v);break}this.get("bIsFreeformLayout")&&(t.initializePanelResizer(c),t.rdResizeDashboardContainer(),c.setStyle("left",t.rdRoundTo10(c.getStyle("left"))),c.setStyle("top",t.rdRoundTo10(c.getStyle("top")))),h.on("drag:start",this.DashboardPanel_onDragStart,this),h.on("drag:end",this.DashboardPanel_onDragEnd,this),h.on("drag:over",this.DashboardPanel_onDragOver,this);var m=c.one('tr[id="'+l+'"]');c.dd.addHandle(m).plug(e.Plugin.DDWinScroll,{scrollDelay:100}),m.setStyle("cursor","move"),this.get("bIsFreeformLayout")?c.setStyle("opacity",".92"):c.setStyle("opacity","1")}}var g=document.getElementsByTagName("TD");for(o=0;o<g.length;o++){var y=g[o];if(y.id.indexOf("rdDashboardColumn")==0){var b=e.one(y).plug(e.Plugin.Drop);b.drop.on("drop:hit",this.DashboardColumn_onDropHit,this)}}var w=document.getElementsByTagName("LI");for(o=0;o<w.length;o++){var E=w[o];if(E.parentNode.parentNode.id.indexOf("rdTabs-")==0&&E.title!="active"&&E.id!="rdTabAddNewTab"){var b=e.one('li[id="'+E.id+'"]').plug(e.Plugin.Drop);b.drop.on("drop:hit",this.Tab_onDropHit,this)}}this.rdSetAddPanelsPopupSize(),this.rdAddRefreshEventForAddPanelsPopupCloseButton(),a<1&&ShowElement(null,"ppChangeDashboard","Show"),t.rdResizeDashboardContainer(),typeof rdMobileReport=="undefined"&&this.rdPositiontabSettingsCog(!0);var S=e.one("#rdTabAddNewTab");if(e.Lang.isValue(S))if(typeof rdMobileReport=="undefined"){var x=S.one("a");x.addClass("hide-tab");var T=x.one("span");T.addClass("rdDashboardCommand")}else{var N=S.getDOMNode().previousSibling,C=175;N.style.width=C+"px",N.style.wordWrap="break-word",N.firstChild.style.paddingLeft="2px",N.firstChild.style.paddingRight="2px",N.firstChild.style.width=C-4+"px",N.firstChild.style.wordWrap="break-word",N.firstChild.style.backgroundRepeat="repeat-x",N.firstChild.firstChild.style.paddingLeft="2px",N.firstChild.firstChild.style.paddingRight="2px",N.firstChild.firstChild.style.width=C-8+"px",N.firstChild.firstChild.style.wordWrap="break-word",this.rdPositiontabSettingsCog(!1)}}},rdClientSideEnableUndo:function(){var e=document.getElementById("lblAutoBookmark");e&&e.value==""&&rdSetUndoRedoVisibility()},DashboardPanel_onDragStart:function(n){var r=n.target.get("dragNode");this.get("bIsFreeformLayout")?(t.freezeDashboardContainer(),t.showPanelonTop(r),r.setStyle("opacity",".75")):r.setStyles({zIndex:1,opacity:.75}),this.rdSetAppletVisibility("hidden");var i=e.one(".rdDashboardPanelContainer");i&&i.simulate("mousedown")},DashboardPanel_onDragEnd:function(n){var r=n.target.get("dragNode");if(this.get("bIsFreeformLayout")){t.unFreezeDashboardContainer();var i=r.getStyle("top").replace("px",""),s=r.getStyle("left").replace("px","");i<0&&r.setStyle("top","0px"),s<0&&r.setStyle("left","0px"),r.setStyle("opacity",".92"),t.rdSaveFreeformLayoutPanelPosition("rdDivDashboardpanels")}else{r.setStyles({zIndex:0,opacity:1,left:0,top:0}),r.all(".rdChartCanvas").each(e.LogiXML.ChartCanvas.reflowChart);if((r.get("id")||"").indexOf("NGPviz")>=0){var o=r.one("div.panelBody");o.setStyle("width",e.one("#lastHoveredDropZoneWidth").get("value"));var u=o.all("div.rdLogiVisualization");if(u.size()>0){var a=r.one(".rdLogiVisualization logi-visualization,.rdLogiVisualization logi-crosstab-table");a&&LogiXML.Dashboard.FreeForm.resizeVisualizationToFitPanel(r,a)}}}var f=r.getXY();this.get("bIsTouchDevice")&&setTimeout(function(){e.LogiInfo.Dashboard.rdResetDashboardPanelAfterDDScroll(r.getDOMNode(),f)},1e3),this.rdSetDropZone(null),this.rdSetAppletVisibility("")},DashboardPanel_onDragOver:function(t){var n=1,r=t.drop.get("node"),i=t.target.get("node"),s=r.getDOMNode(),o=i.getDOMNode();if(!this.get("bIsFreeformLayout")&&r.get("id").indexOf("rdDashboardColumn")==0){var u,a,f,l;for(var c=0;c<s.childNodes.length;c++)if(s.childNodes[c].id.indexOf("rdDashboardDropZone")!=-1){u=s.childNodes[c];var h=this.rdGetDbPanelHeight(o),p=this.rdGetDbPanelHeight(u);a?Math.abs(h-p)<f&&(a=u,f=Math.abs(h-p)):(a=u,f=Math.abs(h-p))}if(a){this.rdSetDropZone(a);var d=document.getElementById("lastHoveredDropZoneWidth");if(!d){var v=document.createElement("input");v.setAttribute("id","lastHoveredDropZoneWidth"),v.setAttribute("type","hidden"),document.body.appendChild(v),d=v}d.setAttribute("value",e.one(a).get("clientWidth"))}}else s.tagName=="LI"?s.parentNode.parentNode.id.indexOf("rdTabs-")==0&&this.rdSetDropZone(s):this.rdSetDropZone(null)},DashboardColumn_onDropHit:function(n){if(!this.get("rdDropZoneId"))return;var r=document.getElementById(this.get("rdDropZoneId"));if(!r)return;if(r.tagName=="TABLE"){var i=n.drag.get("node");i.setStyles({left:0,top:0});if(i.get("id").replace("rdDashboardPanel","rdDashboardDropZone")==this.get("rdDropZoneId")){this.rdSetDropZone(null);return}var s=document.getElementById(i.get("id").replace("rdDashboardPanel","rdDashboardDropZone")),o=document.getElementById(i.get("id"));r.nextSibling?(r.parentNode.insertBefore(s,r.nextSibling),r.parentNode.insertBefore(o,r.nextSibling)):(r.parentNode.appendChild(o),r.parentNode.appendChild(s)),this.rdSetDropZone(null),this.rdSaveDashboardOrder();var u=i.one("logi-visualization,logi-crosstab-table"),a=e.one("#lastHoveredDropZoneWidth");if(u){if(a){var f=i.one(".chartfx-wrapper");f.setStyle("width",a.get("value"))}t.resizeVisualizationToFitPanel(i,u)}var l=i.one(".rdChartCanvas");l&&(l.setStyle("width",null),e.LogiXML.ChartCanvas.reflowAllCharts())}},Tab_onDropHit:function(t){if(!this.get("rdDropZoneId"))return;var n=document.getElementById(this.get("rdDropZoneId"));if(!n)return;var r=t.drag.get("node"),s=r.get("id"),o=e.one("#rdDashboardSingleInstanceOnlyPanelsList");if(o!=null){var u=o.getDOMNode().value.split(",");for(i=0;i<u.length;i++){var a=u[i];if(a==s.substring(s.indexOf("rdDashboardPanel-")+"rdDashboardPanel-".length,s.lastIndexOf("_")))return}}this.rdMovePanelToTab(s,t.target.get("node").get("id"),n)},rdAddDashboardPanel:function(t,n,r){t.indexOf("NGPviz")>=0&&(bIsNgpViz=!0);var i=document.getElementById("rdFreeformLayout");i!=null&&i.id.toLowerCase()=="rdhiddenrequestforwarding"&&(i=null);var s="&rdReport="+document.getElementById("rdDashboardDefinition").value;s+="&PanelID="+t;var o=document.getElementById("rdActiveTabId_rdDashboardTabs");e.Lang.isValue(o)&&(s+="&TabID="+o.value),this.rdCalculatezIndexValue();if(i)s+="&rdFreeformLayout=True",s+="&rdNewFreeformLayoutPanel=True",s+="&rdFreeformLayoutStyle=Position:absolute;Left:"+rdNewPanelCnt*25+"px;Top:"+rdNewPanelCnt*25+"px;z-index:"+this.get("zIndex")+";",bIsNgpViz&&(s+="height:400px;"),s+="&rdDashboardTabStyle=Width:"+e.DOM.winWidth()+"px;Height:"+(e.DOM.winHeight()-e.DOM.region(e.DOM.byId("rdDashboardList")).top-50)+"px;";else{var u=e.one(".rdDashboardPanelContainer");s+="&rdDashboardTabStyle=Width:"+u.get("offsetWidth")+"px;"}rdNewPanelCnt+=1,this.rdClientSideEnableUndo(),rdAjaxRequestWithFormVars("rdAjaxCommand=rdAjaxNotify&rdNotifyCommand=AddDashboardPanel"+s);if(typeof r=="undefined"){var a=document.getElementById("lblCount_Row"+n);a.innerHTML=parseInt(a.innerHTML)+1;var f=document.getElementById("divCount_Row"+n);f.className=f.className.replace("rdDashboardHidden","");var l=document.getElementById("divAdded_Row"+n);l.className=l.className.replace("rdDashboardHidden","");if(document.getElementById("hiddenMultiInstance_Row"+n).value=="False"){var c=document.getElementById("lblAddPanel_Row"+n);c.className="rdDashboardHidden",f.className="rdDashboardHidden";if(e.Lang.isNull(e.one("#rdUseGalleryFile"))){var h=document.getElementById("lblDeletePanel_Row"+n);h.className="rdDashboardHidden"}}}else{var p=e.one("#"+r),a=p.one("#lblCount_Row"+n).getDOMNode();a.innerHTML=parseInt(a.innerHTML)+1;var f=p.one("#divCount_Row"+n).getDOMNode();f.className=f.className.replace("rdDashboardHidden","");var l=p.one("#divAdded_Row"+n).getDOMNode();l.className=l.className.replace("rdDashboardHidden","");if(p.one("#hiddenMultiInstance_Row"+n).getDOMNode().value=="False"){var c=p.one("#lblAddPanel_Row"+n).getDOMNode();c.className="rdDashboardHidden",f.className="rdDashboardHidden";var h=p.one("#lblDeletePanel_Row"+n).getDOMNode();h.className="rdDashboardHidden"}}},rdCalculatezIndexValue:function(){var t=e.one("#rdDivDashboardPanelTable"),n=t.all(".rdDashboardPanel"),r=n.size(),i,s;if(r===0){this.set("zIndex",this.get("zIndex")+1);return}for(i=0;i<r;i++){s=n.item(i);var o=s.getComputedStyle("zIndex");this.get("zIndex")<=o&&this.set("zIndex",parseInt(o)+1)}},rdRemoveDashboardPanel:function(e,n){var r=document.getElementById("rdFreeformLayout");r!=null&&r.id.toLowerCase()=="rdhiddenrequestforwarding"&&(r=null);var i=document.getElementById(e);if(i){var s=document.getElementById(e.replace("rdDashboardPanel","rdDashboardDropZone"));i.parentNode.removeChild(i),s&&s.parentNode.removeChild(s);var o=e.replace("rdDashboardPanel-",""),u=document.getElementsByTagName("INPUT");for(var a=0;a<u.length;a++){var f=u[a];f.parentNode.innerHTML.indexOf("&quot;,"+o+"&quot;")!=-1&&(f.checked=!1)}var l="&rdReport="+document.getElementById("rdDashboardDefinition").value;l+="&PanelInstanceID="+this.rdGetPanelInstanceId(i),r&&(t.rdResizeDashboardContainer(),l+="&rdFreeformLayout=True"),l+="&DashboardID="+document.getElementById("DashboardIdentifier").value,this.rdClientSideEnableUndo(),rdAjaxRequestWithFormVars("rdAjaxCommand=rdAjaxNotify&rdNotifyCommand=RemoveDashboardPanel"+l)}},rdDeleteCustomDashboardPanel:function(t,n,r,i){var s="&rdReport="+document.getElementById("rdDashboardDefinition").value;s+="&sPanelID="+t;var o=document.getElementById("rdActiveTabId_rdDashboardTabs");e.Lang.isValue(o)&&(s+="&TabID="+o.value),rdAjaxRequestWithFormVars("rdAjaxCommand=rdAjaxNotify&rdNotifyCommand=DeleteCustomDashboardPanel"+s);var u=document.getElementById("dtPanelList");u.childNodes[0].childNodes[n-1].style.display="none"},rdSetDropZone:function(e){if(this.get("rdDropZoneId")){var t=document.getElementById(this.get("rdDropZoneId"));t&&(t.tagName=="TABLE"?t.firstChild.firstChild.firstChild.className="rdDashboardDropZone":t.firstChild.firstChild.firstChild.className=t.firstChild.firstChild.firstChild.className.replace(" rdDashboardDropTabActive",""))}e?(this.set("rdDropZoneId",e.id),e.tagName=="TABLE"?e.firstChild.firstChild.firstChild.className="rdDashboardDropZoneActive":e.firstChild.firstChild.firstChild.className=e.firstChild.firstChild.firstChild.className+" rdDashboardDropTabActive"):this.set("rdDropZoneId",null)},rdSaveDashboardOrder:function(){var e=document.getElementById("rdDashboardPanelOrder");e.value="";var t=document.getElementsByTagName("DIV");for(var n=0;n<t.length;n++){var r=t[n];if(r.id.indexOf("rdDashboardPanel")==0){e.value+=","+this.rdGetPanelInstanceId(r);var i=r.parentNode.id.replace("rdDashboardColumn","");e.value+=":"+i}}var s="&rdReport="+document.getElementById("rdDashboardDefinition").value;window.status="Saving dashboard panel positions.",this.rdClientSideEnableUndo(),rdAjaxRequestWithFormVars("rdAjaxCommand=rdAjaxNotify&rdNotifyCommand=UpdateDashboardPanelOrder"+s)},rdSaveDashboardParams:function(n,r,i){if(typeof i=="undefined"&&document.activeElement.id.indexOf("rdDashboardPanelRename-")!=-1)return;var s=rdValidateForm();if(s){alert(s);return}var o=n.replace("rdDashboardPanel-",""),u=document.getElementById(n),a=e.one("#rdDashboardPanelRenameDiv-"+o);e.Lang.isNull(a)||a.setStyle("display","none");var f=e.one("#rdDashboardPanelCaptionDiv-"+o);f.setStyle("display","");var l=e.one("#rdPanelSettingsCog_"+o);l.setStyle("display","");if(!e.Lang.isNull(a)){var c=a.one("#"+a.get("id").replace("rdDashboardPanelRenameDiv-","rdDashboardPanelRename-")).get("value");if(f.one("#rdDashboardCaptionID").getHTML()!=c)f.one("#rdDashboardCaptionID").setHTML(c);else if(typeof r!="undefined")return}var h={parameters:"",ids:""};h=this.rdGetRecursiveInputValues(u,h),h=this.rdGetRecursiveInputValues(document.getElementById("ppPanelParams-"+o),h),h.parameters+="&rdReport="+document.getElementById("rdDashboardDefinition").value,h.parameters.indexOf("&InstanceID")==-1&&(h.parameters+="&InstanceID="+this.rdGetPanelInstanceId(u)),typeof r!="undefined"&&(h.parameters+="&bPanelRename=true"),window.status="Saving dashboard panel parameters.";var p=e.one(u),d=e.bind(t.initializePanel,window,p,p.getData("resizer"));rdAjaxRequestWithFormVars("rdAjaxCommand=rdAjaxNotify&rdNotifyCommand=SaveDashboardParams&PanelID="+o+h.parameters+"&ParamIDs="+h.ids,null,null,null,null,d)},rdEditDashboardPanel:function(e){var t=document.getElementById(e),n=e.substring(17),r=document.getElementById("rdDashboardPanelCaptionDiv-"+n),i=document.getElementById("rdDashboardCancel-"+n);try{r&&i&&(i.outerHTML?i.outerHTML.indexOf("rdIgnore")!=-1&&ShowElement(this.id,r,"Show"):new XMLSerializer&&(new XMLSerializer).serializeToString(i).indexOf("rdIgnore")!=-1&&ShowElement(this.id,r,"Show"))}catch(s){}this.rdPreventDragFromRename("rdDashboardPanelRename-"+n)},rdGetRecursiveInputValues:function(t,n){for(var r=0;r<t.childNodes.length;r++){var i=t.childNodes[r];if(!(!i.nodeName||i.nodeName.toLowerCase()!=="shape"&&i.nodeName.toLowerCase()!=="#text"))break;if(i.getAttribute("data-checkboxlist")){c=i.id+"="+rdGetSelectedValuesFromCheckboxList(i.id),n.parameters.indexOf(c)<0&&(n.parameters+="&"+c);var s=n.ids.split(":"),o=!1;for(var r=0;r<s.length;r++)s[r]===i.id&&(o=!0);o||(n.ids+=":"+i.id);break}if(!e.Lang.isNull(i.id)&&n.ids.indexOf(i.id)>-1&&i.id.length>0){var u=n.ids.split(":"),a=!1;for(var f=0;f<u.length;f++){var l=u[f];if(l===i.id){a=!0;break}}if(a)continue}switch(i.type){case"hidden":case"text":case"email":case"number":case"tel":case"textarea":case"password":case"select-one":case"rdRadioButtonGroup":case"file":var c=rdGetFormFieldValue(i);n.parameters+="&"+i.name+"="+rdAjaxEncodeValue(c),n.ids+=":"+i.name;break;case"select-multiple":var h=new Array;for(var p=0;p<i.length;p++)i.options[p].selected&&(h[h.length]=i.options[p].value);typeof window.rdInputValueDelimiter=="undefined"&&(window.rdInputValueDelimiter=",");var c=h.join(rdInputValueDelimiter);n.parameters+="&"+i.name+"="+rdAjaxEncodeValue(c),n.ids+=":"+i.name;break;case"checkbox":if(i.checked){var c=rdGetInputValues(i);n.parameters.indexOf(c)<0&&(n.parameters+=c);var s=n.ids.split(":"),o=!1;for(var r=0;r<s.length;r++)s[r]===i.name&&(o=!0);o||(n.ids+=":"+i.name)}break;default:if(i.getAttribute){if(i.getAttribute("type")=="rdRadioButtonGroup"){var c=rdGetFormFieldValue(i);n.ids.indexOf(i.getAttribute("name"))<0&&(n.parameters+="&"+i.getAttribute("name")+"="+rdAjaxEncodeValue(c),n.ids+=":"+i.getAttribute("name"));break}n=this.rdGetRecursiveInputValues(i,n);break}n=this.rdGetRecursiveInputValues(i,n)}}return n},rdRenameDashboardTab:function(t){if(typeof t=="undefined"&&document.activeElement.id.indexOf("txtRenameTab")!=-1)return;var n=e.one("#rdSettingsCog");n.setStyle("display",""),e.one("#rdRenameTabDiv").setStyle("display","none");var r=document.getElementById("rdActiveTabId_rdDashboardTabs").value,i=document.getElementById(r),s=e.one("#txtRenameTab").getDOMNode(),o=s.value,u;i.textContent?u=i.textContent:u=i.innerText;var a=e.one(i).one("#rdCaption_"+r).getDOMNode();if(o.replace(/ /g,"").length==0){document.getElementById("txtRenameTab").value=u;return}a.textContent?a.textContent=o:a.innerText=o;var f="&rdReport="+document.getElementById("rdDashboardDefinition").value;f+="&TabID="+r,f+="&NewName="+rdAjaxEncodeValue(o),bSubmitFormAfterAjax=!0,this.rdClientSideEnableUndo(),rdAjaxRequestWithFormVars("rdAjaxCommand=rdAjaxNotify&rdNotifyCommand=RenameDashboardTab"+f),LogiXML.Dashboard.pageDashboard.rdPositiontabSettingsCog()},rdShowRenameTab:function(){var t=document.getElementById("rdActiveTabId_rdDashboardTabs").value,n=document.getElementById(t),r=e.one("#rdSettingsCog");r.setStyle("display","none");var i=e.one(n).one("#rdCaption_"+t),s=e.one(n),o=e.one("#rdRenameTabDiv");o.setStyles({left:s.getX()+5,top:i.getY(),display:"",position:"absolute",width:s.get("scrollWidth")-20});var u=e.one("#txtRenameTab");u.setStyle("width","100%"),u.focus()},rdShowRenamePanel:function(t,n){var r=e.one(t),i=e.one("#rdDashboardPanelRenameDiv-"+n);i.setStyle("display","");var s=e.one("#rdDashboardPanelCaptionDiv-"+n);s.setStyle("display","none");var o=e.one("#rdPanelSettingsCog_"+n);o.setStyle("display","none");var u=e.one("#rdDashboardPanelRename-"+n);u.focus()},rdShowRenamePanel:function(t,n){var r=e.one(t),i=e.one("#rdDashboardPanelRenameDiv-"+n);i.setStyle("display","");var s=e.one("#rdDashboardPanelRename-"+n).getDOMNode();if(s.createTextRange){var o=s.createTextRange();o.move("character",s.value.length-1),o.select()}else s.focus(),s.setSelectionRange(s.value.length,s.value.length);var u=e.one("#rdDashboardPanelCaptionDiv-"+n);u.setStyle("display","none")},rdMoveDashboardTab:function(e){var t=document.getElementById("rdActiveTabId_rdDashboardTabs").value,n=document.getElementById(t),r=document.getElementById("rdTabPanel_"+t),i=!1;switch(e){case"Left":var s=n.previousSibling,o=r.previousSibling;s&&o&&(n.parentNode.insertBefore(n.parentNode.removeChild(n),s),r.parentNode.insertBefore(r.parentNode.removeChild(r),o),i=!0);break;case"Right":var s=n.nextSibling,o=r.nextSibling;s&&o&&s.getAttribute("id")!="rdTabAddNewTab"&&(s.nextSibling?(n.parentNode.insertBefore(n.parentNode.removeChild(n),s.nextSibling),r.parentNode.insertBefore(r.parentNode.removeChild(r),o.nextSibling),i=!0):(n.parentNode.appendChild(n.parentNode.removeChild(n)),r.parentNode.appendChild(r.parentNode.removeChild(r)),i=!0))}if(i){var u="&rdReport="+document.getElementById("rdDashboardDefinition").value;u+="&TabID="+t,u+="&Direction="+e,this.rdClientSideEnableUndo(),rdAjaxRequest("rdAjaxCommand=rdAjaxNotify&rdNotifyCommand=MoveDashboardTab"+u)}},rdMovePanelToTab:function(t,n,r){var i=document.getElementById(t);if(i){var s=document.getElementById(t.replace("rdDashboardPanel","rdDashboardDropZone"));i.parentNode.removeChild(i),s&&s.parentNode.removeChild(s),e.Lang.isNull(r.firstChild)||(r.firstChild.firstChild.firstChild.className=r.firstChild.firstChild.firstChild.className.replace(" rdDashboardDropTabActive",""));var o="&rdReport="+document.getElementById("rdDashboardDefinition").value;o+="&PanelInstanceID="+this.rdGetPanelInstanceId(i),o+="&TabID="+n,this.rdClientSideEnableUndo(),rdAjaxRequest("rdAjaxCommand=rdAjaxNotify&rdNotifyCommand=MoveDashboardPanelToTab"+o)}},rdPositiontabSettingsCog:function(t){if(typeof t!="undefined"){setTimeout(this.rdPositiontabSettingsCog,500);return}var n=e.one("#rdSettingsCog"),r=e.one(".selected");if(e.Lang.isNull(r)){n.setStyle("display","");return}typeof rdMobileReport=="undefined"&&r.get("firstChild").setStyle("cursor","move");var i=e.one("#rdAddTabCog"),s;if(!e.Lang.isNull(r)){var o=e.DOM.region(r.getDOMNode());if(typeof rdMobileReport=="undefined"){n.setStyles({display:""});var u=n.one("img").getDOMNode(),s=u.getAttribute("rdRegionTop"),a=u.getAttribute("rdExtraMarginLeft"),f=e.DOM.region(n.one("img").getDOMNode()),l=e.DOM.region(e.one("#rdTabs ul").getDOMNode());s==null&&(s=f.top,a=f.left-l.left,u.setAttribute("rdRegionTop",s),u.setAttribute("rdExtraMarginLeft",a)),e.Lang.isNull(i)?n.setStyles({"margin-left":5,"margin-top":0,position:"absolute"}):n.setStyles({"margin-left":o.left+o.width-l.left-a-f.width-4,"margin-top":o.top-s+4,position:"absolute"})}else n.setStyles({left:o.left+o.width-24,top:o.top+4,position:"absolute",display:""})}var c=e.one("#rdTabs ul");if(!e.Lang.isNull(i)){i.setStyles({display:""});var h=e.DOM.region(c.getDOMNode());i.setStyles({"margin-left":c.get("scrollWidth")+15,"margin-top":h.top-s,position:"absolute"})}},rdAddNewTab:function(){var t=e.one("#rdTabs-rdDashboardTabs").getData("tabs");document.getElementById("rdActiveTabIndex_rdDashboardTabs").value="0",document.getElementById("rdActiveTabId_rdDashboardTabs").value="rdTabAddNewTab";var n=e.all(e.one("input[name=rdDashboardTabs]"));for(i=0;i<n.size();i++){var r=n.item(i);typeof r.get("value")!="undefined"&&r.set("value","rdTabAddNewTab")}t.TabsTarget().fire("selectedTabChanged"),this.rdRefreshDashboard()},rdRefreshDashboard:function(t){var n=e.one("#DashboardIdentifier"),r=document.getElementById("rdActiveTabId_rdDashboardTabs");e.Lang.isNull(r)?rdAjaxRequest("rdAjaxCommand=RefreshElement&rdRefreshElementID="+n.get("value")+",rdDivDashboardpanels"+"&rdRefreshDashboard=True&rdReport="+document.getElementById("rdDashboardDefinition").value+"&rdRequestForwarding=Form"):rdAjaxRequest("rdAjaxCommand=RefreshElement&rdRefreshElementID="+n.get("value")+",rdDashboardTabs"+"&rdRefreshDashboard=True&rdReport="+document.getElementById("rdDashboardDefinition").value+"&rdRequestForwarding=Form");if(bIsNgpViz!==undefined&&bIsNgpViz==1&&!window.Logi){var i=window.location.href;i&&i.indexOf&&i.indexOf(!0)?(i=i.replace("&rdNewBookmark=True",""),window.location.replace(i)):window.location=window.location}},rdAddDashboardPanels:function(){rdNewPanelCnt>0&&(rdNewPanelCnt=0,LogiXML.Dashboard.pageDashboard.rdRefreshDashboard()),window.location.href.indexOf("&rdCommand=Undo")>-1&&(window.location.href=window.location.href.replace("&rdCommand=Undo","")),window.location.href.indexOf("&rdCommand=Redo")>-1&&(window.location.href=window.location.href.replace("&rdCommand=Redo","")),ShowElement(null,"ppChangeDashboard","Hide")},rdAddRefreshEventForAddPanelsPopupCloseButton:function(){var t=e.one("#ppChangeDashboard"),n=t.all("#rdPopupPanelX").get("node")[0];typeof this.rdAddDashboardPanels=="undefined"?n.on("click",LogiXML.Dashboard.pageDashboard.rdAddDashboardPanels):n.on("click",this.rdAddDashboardPanels)},rdRefreshDashboardPanel:function(e,t,n){rdAjaxRequest("rdAjaxCommand=RefreshElement&rdRefreshElementID=rdDashboardPanels&rdRefreshDashboard=True&rdReport="+document.getElementById("rdDashboardDefinition").value+"&rdRequestForwarding=Form")},rdAddRefreshEventForPanelEditPopupCloseButton:function(t,n){if(typeof n=="undefined"||n==="")return;var r=e.one("#"+t.replace("rdDashboardPanel-","ppPanelParams-")),i=r.all("#rdPopupPanelX").get("node")[0];typeof this.rdRefreshDashboardPanel=="undefined"?i.on("click",LogiXML.Dashboard.pageDashboard.rdRefreshDashboardPanel,null,t):i.on("click",this.rdRefreshDashboardPanel,null,t)},rdSetAddPanelsPopupSize:function(){var t=document.getElementById("rdAddPanelsList");if(t){var n=3*(e.one("body").get("winHeight")/4)>400?3*(e.one("body").get("winHeight")/4):400;t.style.height=n+"px",t.style.overflow="auto"}},rdSetDashboardColumns:function(e){var t=document.getElementById("ActiveTabIdentifier").value,n=document.getElementById(t),r=document.getElementById("lstColumnCount").value,i=rdGetFormFieldValue(document.getElementById("rdRadioButtonGroupradWideColumn"));if(typeof e=="undefined"){var s="&rdReport="+document.getElementById("rdDashboardDefinition").value;s+="&TabID="+t,s+="&NewColumnCount="+r,s+="&NewWideColumn="+i,rdAjaxRequestWithFormVars("rdAjaxCommand=rdAjaxNotify&rdNotifyCommand=SetDashboardTabColumns"+s)}if(r=="Free-form"){document.getElementById("divFreeformPanels").style.display="";var o=document.getElementById("rdFreeformLayout");o!=null&&o.id.toLowerCase()=="rdhiddenrequestforwarding"&&(o=null),o==null&&(o=document.createElement("INPUT"),o.setAttribute("TYPE","HIDDEN"),o.setAttribute("ID","rdFreeformLayout"),o.setAttribute("NAME","rdFreeformLayout"),o.style.display="none",n.appendChild(o));return}var u=document.getElementById("divFreeformPanels");u&&(u.style.display="none");var o=document.getElementById("rdFreeformLayout");o&&o.parentNode.removeChild(o)},rdGetPanelInstanceId:function(e){return e.id.substr(e.id.lastIndexOf("_")+1)},rdRemoveDashboardParams:function(){var e=document.getElementById("rdDashboardParams");while(e)e.parentNode.removeChild(e),e=document.getElementById("rdDashboardParams")},rdMoveMobileDashboardPanel:function(e,t,n){ShowElement(this.id,n,"Toggle");var r=document.getElementById(e),i=r.nextSibling,s=i.nextSibling,o=null,u=null,a=null,f=null;r.previousSibling!=null&&r.previousSibling.previousSibling!=null&&r.previousSibling.previousSibling.previousSibling!=null&&(o=r.previousSibling.previousSibling.previousSibling),r.nextSibling!=null&&r.nextSibling.nextSibling!=null&&r.nextSibling.nextSibling.nextSibling!=null&&(u=r.nextSibling.nextSibling.nextSibling,a=u.nextSibling,f=a.nextSibling);switch(t){case"MoveUp":if(o!=null){s.parentNode.insertBefore(s,o),i.parentNode.insertBefore(i,s),r.parentNode.insertBefore(r,i),this.rdSaveDashboardOrder();break};case"MoveDown":if(u!=null){f.parentNode.insertBefore(f,r),a.parentNode.insertBefore(a,f),u.parentNode.insertBefore(u,a),this.rdSaveDashboardOrder();break};case"Edit":this.rdEditDashboardPanel(e);break;case"Remove":confirm("Are you sure?")&&this.rdRemoveDashboardPanel(e);break;default:this.rdMovePanelToTab(e,t,s)}},rdNavigateBetweenDashboardTabs:function(e,t){ShowElement(this.id,t,"Hide"),document.getElementById("rdActiveTabIndex_rdDashboardTabs").value="0",document.getElementById("rdActiveTabId_rdDashboardTabs").value=e;var n=document.getElementById("rdDashboardDefinition").value;SubmitForm("rdPage.aspx?rdReport="+n+"&rdRequestForwarding=Form","","false")},rdShowChangePanelMenu:function(e,t){ShowElement(this.id,e,"Toggle");try{var n=document.getElementById(e),r=document.getElementById(t),s=r.previousSibling,o=r.nextSibling.nextSibling.nextSibling;if(s.id.match("rdDashboardDropZone-0-0")){var u=n.getElementsByTagName("td");for(i=0;i<u.length;i++){var a=u[i];a.outerHTML.match("MoveUp")&&a.getAttribute("id")&&a.getAttribute("id").match("rdDataMenuTable_Row")&&(a.parentNode.style.display="none")}}else{var u=n.getElementsByTagName("td");for(i=0;i<u.length;i++){var a=u[i];a.outerHTML.match("MoveUp")&&a.getAttribute("id")&&a.getAttribute("id").match("rdDataMenuTable_Row")&&(a.parentNode.style.display="")}}if(!o){var u=n.getElementsByTagName("td");for(i=0;i<u.length;i++){var a=u[i];a.outerHTML.match("MoveDown")&&a.getAttribute("id")&&a.getAttribute("id").match("rdDataMenuTable_Row")&&(a.parentNode.style.display="none")}}else{var u=n.getElementsByTagName("td");for(i=0;i<u.length;i++){var a=u[i];a.outerHTML.match("MoveDown")&&a.getAttribute("id")&&a.getAttribute("id").match("rdDataMenuTable_Row")&&(a.parentNode.style.display="")}}}catch(f){}},rdSizeUnAdjustablePanels
:function(t){var n=e.Selector.query("."+t,e.DOM.byId("rdDivDashboardpanels"));for(var r=0;r<n.length;r++){var i=n[r],s=i.offsetHeight-4+"px",o=i.offsetWidth-4+"px";i.style.height=s,i.style.width=o;var u=e.one("#"+i.id.replace("rdDashboardPanel-","rdDashboard2PanelContent_")).getDOMNode();u.style.overflow="visible",i.style.overflow="hidden"}},rdSetDashboardPanelOpacity:function(t,n){var r=e.all(".rdDashboardPanel");for(var i=0;i<r.size();i++){var s=r.item(i);if(s.get("id")==t.get("id"))continue;s.setStyle("opacity",n)}},rdResizePanelContentOnEditCancelSave:function(e,n){if(document.getElementById("rdFreeformLayout")==null)return;var r=this,i=document.getElementById(n[0]),s=document.getElementById(n[1]),o=n[2],u=s.firstChild,a=u.firstChild.firstChild,f=a.offsetHeight,l=a.nextSibling,c=0;if(l.style.display=="none"){if(o=="Edit"){setTimeout(function(){r.rdResizePanelContentOnEditCancelSave(e,n)},10);return}}else if(o=="Save"||o=="Cancel"){setTimeout(function(){r.rdResizePanelContentOnEditCancelSave(e,n)},10);return}c=navigator.appVersion.match("MSIE 8.0")!=null?l.clientHeight:l.offsetHeight;var h=i.offsetHeight+f+c+12;s.style.height=(h<20?20:h)+"px",s.style.width=u.offsetWidth+"px",t.rdResizeDashboardContainer()},rdPreventDragFromRename:function(e){var t=document.getElementById(e);t&&(t.onmousedown=function(e){return e=e||window.event,e.cancelBubble=!0,!0})},rdGetDbPanelHeight:function(e){return e.offsetParent?this.rdGetDbPanelHeight(e.offsetParent)+e.offsetTop:e.offsetTop},rdSetAppletVisibility:function(e){var t=document.getElementsByTagName("applet");for(var n=0;n<t.length;n++){var r=t[n];r.style.visibility=e}t=document.getElementsByTagName("object");for(var n=0;n<t.length;n++){var r=t[n];r.style.visibility=e}t=document.getElementsByTagName("embed");for(var n=0;n<t.length;n++){var r=t[n];r.style.visibility=e}}},{NAME:"dashboard",ATTRS:{rdDropZoneId:{},bIsFreeformLayout:{value:!1},bIsTouchDevice:{value:LogiXML.features.touch},bDashboardAdjustable:{value:!0},zIndex:{value:0}},rdResetDashboardPanelAfterDDScroll:function(t,n){var r=e.one(t);r.setXY(n)}})},"1.0.0",{requires:["dd-drop-plugin","dd-plugin","dd-scroll","dashboard-freeform"]});var sColorPicker="1",sPanelInstanceId="",elePanel=null,eleParamsPopup=null,bIsNgpViz=!1;YUI.add("dashboard-freeform",function(e){var t=e.namespace("LogiXML.Dashboard.FreeForm"),n="dashboardChart",r=function(t){return t=e.one(t),e.Lang.isValue(t)?s(t,"w"):NaN},i=function(t){return t=e.one(t),e.Lang.isValue(t)?s(t,"h"):NaN},s=function(e,t){return t=t.toLowerCase(),t==="w"||t==="width"?e.get("clientWidth")-parseInt(e.getComputedStyle("paddingLeft"),10)-parseInt(e.getComputedStyle("paddingRight"),10):t==="h"||t==="height"?e.get("clientHeight")-parseInt(e.getComputedStyle("paddingTop"),10)-parseInt(e.getComputedStyle("paddingBottom"),10):NaN};t.initializePanelResizer=function(n){var r=e.one(n),i=e.one("#rdResizerAttrs_"+r.get("id")),s,o;if(!e.Lang.isValue(i))return;o=r.all("img.dashboardChart,div.rdChartCanvas"),s=e.rdResize.AddYUIResizerHandles(r.get("id"),i),r.setData("resizer",s),t.initializePanel(r,s),t.addResizeEventHandlers(s,r,o.size()===1)},t.initializePanel=function(n,r){var i=n.all("img.dashboardChart,div.rdChartCanvas"),s=r||n.getData("resizer");i.size()!==1?t._initializeMultiContentPanel(n,i):t._initializeSingleChartPanel(n,i.item(0),s),i.each(function(r){LogiXML.Ajax.AjaxTarget().on("reinitialize",e.bind(t._reinitializeChart,this,"#"+r.get("id"),"#"+n.get("id")))},this);var o=n.one(".rdLogiVisualization logi-visualization,.rdLogiVisualization logi-crosstab-table");o&&t.resizeVisualizationToFitPanel(n,o)},t._reinitializeChart=function(n,r){var i=e.one(n),s=e.one(r);if(e.Lang.isNull(s))return;!e.Lang.isNull(i)&&(e.Lang.isValue(i)&&i.hasClass("rdChartCanvas")&&!e.Lang.isValue(i.getData("rdChartCanvas"))||i.get("src")&&i.get("src").indexOf("rd1x1Trans.gif")!=-1)&&(t.resizeChartToFitPanel(s,i),typeof s.getData("resizer")!="undefined"&&s.getData("resizer").addTarget(i))},t._initializeChartImage=function(t,n,r){var i=t.get("src");i&&(i=i.replace("rdTemplate/rd1x1Trans.gif","rdTemplate/rdChart2.aspx"),e.Lang.isValue(n)&&e.Lang.isValue(r)&&(i=i+"&rdResizeWidth="+n+"&rdResizeHeight="+r),t.set("src",i))},t._isFirstPanelLoad=function(e){var t=e.getDOMNode().style;return t.width===""&&t.height===""},t._initializeSingleChartPanel=function(n,r,i){var s=t._isFirstPanelLoad(n);s?(r.once("load",function(){t.resizePanelBodytoFitPanel(n);var r=e.one("#rdResizerAttrs_"+n.get("id"));n.get("offsetWidth")<r.getAttribute("rdMinWidth")?n.setStyle("width",r.getAttribute("rdMinWidth")):n.setStyle("width",n.get("offsetWidth")),n.get("offsetHeight")<r.getAttribute("rdMinHeight")?n.setStyle("height",r.getAttribute("rdMinHeight")):n.setStyle("height",n.get("offsetHeight")),t.rdSaveFreeformLayoutPanelPosition("rdDivDashboardpanels")}),t._initializeChartImage(r),r.removeAttribute("width")):(t.resizePanelBodytoFitPanel(n),t.resizeChartToFitPanel(n,r),t.rdResizeDashboardContainer()),typeof i!="undefined"&&i.addTarget(r)},t._initializeMultiContentPanel=function(n,r){var i=t._isFirstPanelLoad(n);i||t.resizePanelBodytoFitPanel(n),r.each(function(r){i&&r.once("load",function(){var r=e.one("#rdResizerAttrs_"+n.get("id"));n.get("offsetWidth")<r.getAttribute("rdMinWidth")?n.setStyle("width",r.getAttribute("rdMinWidth")):n.setStyle("width",n.get("offsetWidth")),n.get("offsetHeight")<r.getAttribute("rdMinHeight")?n.setStyle("height",r.getAttribute("rdMinHeight")):n.setStyle("height",n.get("offsetHeight")),t.rdResizeDashboardContainer}),t._initializeChartImage(r),r.removeAttribute("width")}),r.isEmpty()&&t.rdResizeDashboardContainer()},t.addResizeEventHandlers=function(e,n,r){e.on("resize:start",t.onPanelResizeStart,this,n,r,e),e.on("resize:resize",t.onPanelResize,this,n,r,e),e.on("resize:end",t.onPanelResizeEnd,this,n,r,e)},t.resizeChartToFitPanel=function(r,i){var s=e.one(i),o=e.one(r),u=o.one(".panelBody"),a,f,l;if((!s.hasClass(n)||s.get("tagName")!=="IMG")&&!s.hasClass("rdChartCanvas"))return;var c=o.all("img.dashboardChart,div.rdChartCanvas");a=o.get("children");var h=e.one("#rdDebugChart"),p=s.ancestor();if(c.size()==1){l=u.get("clientHeight"),f=u.get("clientWidth"),e.Lang.isValue(h)&&h.get("tagName")==="IMG"&&(l-=30);var d=[".rdBookmarkLinkbackContainer"],v;for(var m=0;m<d.length;m++)v=r.one(d[m]),v&&(l-=v.get("clientHeight"));l<=5&&(l=5),f<=5&&(f=5),t.hideOrShoeChartCanvasTooltips(u,!1),i.set("width",f),i.set("height",l),i.set("offsetWidth",f),i.set("offsetHeight",l),p.hasClass("chartfx-wrapper")&&(p.set("offsetWidth",f),p.set("offsetHeight",l)),u.setStyle("overflow","scroll"),l-=u.get("scrollHeight")-u.get("clientHeight"),l<=5&&(l=5),i.set("height",l),i.set("offsetHeight",l),p.hasClass("chartfx-wrapper")&&p.set("offsetHeight",l),f-=u.get("scrollWidth")-u.get("clientWidth"),f<=5&&(f=5);if(!s.hasClass("rdChartCanvas")){i.set("width",f),i.set("offsetWidth",f),p.hasClass("chartfx-wrapper")&&p.set("offsetWidth",f);var g=i,y,b,w,E;y=i.get("src"),b=y.split("?"),w=b[1],E=e.QueryString.parse(w),E.hasOwnProperty("rdResizeWidth")?(E.rdResizeWidth=f,E.rdResizeHeight=l,y=b[0]+"?"+e.QueryString.stringify(E),i.set("src",y)):t._initializeChartImage(i,f,l)}else e.Lang.isValue(i.getData("rdChartCanvas"))?i.fire("setSize",{width:f,height:l,finished:!0,notify:!1}):(i.setAttribute("data-width",f),i.setAttribute("data-height",l));u.setStyle("overflow","hidden"),t.hideOrShoeChartCanvasTooltips(u,!0)}},t.resizeVisualizationToFitPanel=function(n,r){var i=e.one(r),s=e.one(n),o=s.one(".panelBody"),u,a,f=(n.get("id")||"").indexOf("NGPviz")>=0,l=s.one("#rdDebugChart");a=o.get("clientHeight"),u=o.get("clientWidth"),e.Lang.isValue(l)&&l.get("tagName")==="IMG"&&(a-=l.get("offsetWidth"));var c=[".rdDashboardFilterCaption",".rdDashboardGlobalFilterCaption"],h;for(var p=0;p<c.length;p++)h=n.one(c[p]),h&&h.one("span").get("innerHTML")&&(a=a-h.get("offsetHeight")-2);a<=5&&(a=5),u<=5&&(u=5),t.hideOrShoeChartCanvasTooltips(o,!1),r.set("width",u),r.set("height",a),r.set("offsetWidth",u),r.set("offsetHeight",a),o.setStyle("overflow","scroll"),f||(a-=o.get("scrollHeight")-o.get("clientHeight")),a<=5&&(a=5),r.set("height",a),r.set("offsetHeight",a),f||(u-=o.get("scrollWidth")-o.get("clientWidth")),u<=5&&(u=5);if(r.get("tagName")==="LOGI-VISUALIZATION"||r.get("tagName")==="LOGI-CROSSTAB-TABLE"){e.LogiXML.rdLogiVisualization.resize(r,u,a,"px","px"),r.get("parentNode").setAttribute("data-skip-initial-resizing","true");if(f){r.get("parentNode").setStyle("width",u),r.get("parentNode").setStyle("height",a),r.get("parentNode").get("parentNode").setStyle("width",u),r.get("parentNode").get("parentNode").setStyle("height",a);var d=r.get("id");if(window.Logi&&window.Logi.Platform&&d){var v=window.Logi.Platform.select("#"+d);v&&v.setSize&&v.setSize(u,a)}}}o.setStyle("overflow","hidden"),t.hideOrShoeChartCanvasTooltips(o,!0)},t.hideOrShoeChartCanvasTooltips=function(e,t){if(!e)return;var n=e.all(".highcharts-tooltip"),r=0,i=n.size();for(r=0;r<i;r++)t?n.item(r).show():n.item(r).hide()},t.resizePanelBodytoFitPanel=function(t){var n=e.one(t),i=n.one(".panelBody"),s=i.ancestor("td"),o=i.ancestor("tr"),u=n.one(".panelInnerTable"),a=u.one(".panelTitle"),f=u.one(".rdDashboardParams"),l,c;if(e.Lang.isValue(n.getData("resizer"))){l=n.get("clientWidth")-(u.get("offsetWidth")-r(s)),i.set("offsetWidth",l),c=n.get("clientHeight")-parseInt(u.getComputedStyle("marginTop"),10)-parseInt(u.getComputedStyle("marginBottom"),10)-(a.getStyle("display")==="none"?0:a.get("offsetHeight"))-(f.getStyle("display")==="none"?0:f.get("offsetHeight"))-parseInt(o.getComputedStyle("paddingTop"),10)-parseInt(o.getComputedStyle("paddingBottom"),10)-parseInt(s.getComputedStyle("paddingTop"),10)-parseInt(s.getComputedStyle("paddingBottom"),10)-parseInt(i.getComputedStyle("marginBottom"),10);var h=[".rdDashboardFilterCaption",".rdDashboardGlobalFilterCaption"],p;for(var d=0;d<h.length;d++)p=t.one(h[d]),p&&(c=c-p.get("clientHeight")-parseInt(p.getComputedStyle("paddingTop"),10)-parseInt(p.getComputedStyle("paddingBottom"),10));i.set("offsetHeight",c)}else n.setStyle("height","")},t.addPanelClickEvents=function(){var n=e.one("#rdDivDashboardpanels");e.Lang.isValue(n)&&n.delegate("click",t.onPanelClick,".rdDashboardPanel",this)},t.onPanelResizeStart=function(n,r,i){var s=e.one(r),o=s.all("img.dashboardChart,div.rdChartCanvas");o.size()==1?s.setData("oneChart",!0):s.setData("oneChart",!1);var u=r.ancestor("#rdDivDashboardpanels");t.freezeDashboardContainer(),t.showPanelonTop(r),r.setStyle("opacity",.75),r.setData("resizeCurrentWidth",r.get("offsetWidth")),r.setData("resizeCurrentHeight",r.get("offsetHeight"))},t.onPanelResize=function(n,r,i,s){var o=r.one("img.dashboardChart,div.rdChartCanvas"),u=r.one(".panelBody"),a=r.get("offsetWidth")-r.getData("resizeCurrentWidth"),f=r.get("offsetHeight")-r.getData("resizeCurrentHeight"),l=e.one(r);if(l.getData("oneChart")&&o){var c=o.ancestor(),h,p;if(o.hasClass("rdChartCanvas")){var d=o.one("*");d!=null?(h=d.get("offsetWidth")+a,p=d.get("offsetHeight")+f):(h=o.get("offsetWidth")+a,p=o.get("offsetHeight")+f)}else h=o.get("width")+a,p=o.get("height")+f;h<=5&&(h=5),p<=5&&(p=5),c.hasClass("chartfx-wrapper")&&(c.set("offsetWidth",h),c.set("offsetHeight",p)),o.set("offsetWidth",h),o.set("offsetHeight",p),o.hasClass("rdChartCanvas")&&o.fire("setSize",{width:h,height:p,finished:!1,notify:!1})}u.set("offsetWidth",u.get("offsetWidth")+a),u.set("offsetHeight",t.getPanelBodyAvailableHeight(r)),r.setData("resizeCurrentWidth",r.get("offsetWidth")),r.setData("resizeCurrentHeight",r.get("offsetHeight"))},t.onPanelResizeEnd=function(n,r,i,s){var o=r.ancestor("#rdDivDashboardpanels"),u,a,f,l,c,h=e.one(r);t.unFreezeDashboardContainer(),o.all(".rdDashboardPanel").setStyle("opacity",.92),t.rdSaveFreeformLayoutPanelPosition("rdDivDashboardpanels");if(h.getData("oneChart"))u=r.one("img.dashboardChart,div.rdChartCanvas"),t.resizeChartToFitPanel(r,u);else{var p=h.one("logi-visualization,logi-crosstab-table");p&&t.resizeVisualizationToFitPanel(r,p)}},t.getPanelBodyAvailableHeight=function(e){var t=e.one(".panelBody"),n=t.ancestor("TR"),r=0,i=n._node.previousSibling;while(i)r+=i.offsetHeight,i=i.previousSibling;var s=20;return nAvailableHeight=e._node.offsetHeight-r-s,nAvailableHeight<0&&(nAvailableHeight=0),nAvailableHeight},t.onPanelClick=function(n){var r=n.currentTarget,i=e.one("#rdDivDashboardpanels");t.showPanelonTop(r),t.rdSaveFreeformLayoutPanelPosition(i.get("id"))},t.showPanelonTop=function(e){var t=e.ancestor(".dashboardPanelContainer"),n=t.all(".rdDashboardPanel"),r=parseInt(e.getStyle("zIndex"),10),i=0,s=0;n.each(function(e){var t=parseInt(e.getStyle("zIndex"),10);i<t?i=t:i==t&&(s+=1)},this),s>1&&(i+=1),r<i&&(r=i+1,e.setStyle("zIndex",r))},t.rdResizeDashboardContainer=function(){var t=e.one("#rdDivDashboardpanels"),n,r;if(t==null){t=e.one("#rdDivDashboardPanelTable");if(e.Lang.isNull(t))return}n=t.all(".rdDashboardPanel");var i=0,s=0;for(r=0;r<n.size();r++){var o=n.item(r),u=e.DOM.region(o.getDOMNode());r==0?(i=u.right,s=u.bottom):(u.right>i&&(i=u.right),u.bottom>s&&(s=u.bottom))}var a=e.DOM.region(t.getDOMNode());if(n.size()>0){var f=e.Selector.ancestor(n.item(0),".rdTabPanel",!1);e.Lang.isValue(document.getElementById("rdFreeformLayout"))&&(t.setStyle("height",s-a.top+20+"px"),i<e.DOM.viewportRegion().right?(t.setStyle("width",e.DOM.viewportRegion().right-a.left-20+"px"),f&&f.setStyle("width",e.DOM.viewportRegion().right-a.left-20+"px"),e.Lang.isNull(e.one("#divMainContent"))||e.one("#divMainContent").setStyle("width",e.DOM.viewportRegion().right-a.left-20+"px")):(t.setStyle("width",i+"px"),f&&f.setStyle("width",i+10+"px"),e.Lang.isNull(e.one("#divMainContent"))||e.one("#divMainContent").setStyle("width",i+"px")))}else t.setStyle("width","100%"),t.setStyle("height","")},t.rdSaveFreeformLayoutPanelPosition=function(n){t.rdResizeDashboardContainer();var r=e.one("#"+n);if(!e.Lang.isValue(r))return;var i=e.one("#rdDashboardPanelOrder"),s=r.all(".rdDashboardPanel"),o=s.size(),u,a,f="";for(u=0;u<o;u++)a=s.item(u),f+=","+e.LogiInfo.Dashboard.prototype.rdGetPanelInstanceId(a.getDOMNode()),f+=":0:STYLE=",f+="z-index:"+a.getComputedStyle("zIndex")+";",f+=" position: "+a.getComputedStyle("position")+";",f+=" left: "+t.rdRoundTo10(a.getComputedStyle("left"))+";",f+=" top: "+t.rdRoundTo10(a.getComputedStyle("top"))+";",f+=" width: "+t.rdRoundTo10(a.getComputedStyle("width"))+";",f+=" height: "+t.rdRoundTo10(parseInt(a.getComputedStyle("height"),10))+"px"+";";i.set("value",f);var l="&rdReport="+document.getElementById("rdDashboardDefinition").value;l+="&rdFreeformLayout=True";var c=e.Selector.ancestor(r,".rdTabPanel");c&&(c.parentNode.setStyle("overflow","hidden"),l+="&rdDashboardTabID="+c.get("id").substring(c.get("id").lastIndexOf("_")+1));var h=e.DOM.region(r.getDOMNode()),p="Width:"+(h.right-h.left)+"px";p+=";Height:"+(h.bottom-h.top)+"px",l+="&rdDashboardTabStyle="+p,window.status="Saving dashboard panel positions.",rdAjaxRequestWithFormVars("rdAjaxCommand=rdAjaxNotify&rdNotifyCommand=UpdateDashboardPanelOrder"+l)},t.rdRoundTo10=function(e){var t=!1;return typeof e.replace!="undefined"&&e.indexOf("px")!=-1&&(t=!0,e=e.replace("px","")),e=parseInt(e/10)*10,t&&(e+="px"),e},t.freezeDashboardContainer=function(){var t=e.one("#rdDivDashboardpanels"),n=t.getDOMNode().clientWidth,r=t.getDOMNode().clientHeight;t.setStyle("position","absolute"),t.ancestor("div").setStyles({width:n,height:r})},t.unFreezeDashboardContainer=function(){var t=e.one("#rdDivDashboardpanels");t.ancestor("div").setStyles({width:"",height:""}),t.setStyle("position","relative")},t.panelFitToChart=function(){var n=e.all("div.rdDashboardPanel");n.each(function(e){var n=e.one("div.panelBody"),r=n.all("div.rdLogiVisualization");if(r.size()!==1){var i=0;r.each(function(e){i+=parseInt(e.get("clientHeight"))}),i>0&&(n.setStyle("height",i),t.resizePanelBodytoFitPanel(e))}else{var s=e.one("logi-visualization,logi-crosstab-table");s&&s.get("parentNode").getAttribute("data-skip-initial-resizing")!="true"&&t.resizeVisualizationToFitPanel(e,s)}}),t.rdResizeDashboardContainer()},LogiXML.Dashboard.FreeForm=t},"1.0.0",{requires:["node-base","rdResize","querystring","dd-constrain","dd-proxy","dd-drop-plugin","dd-plugin","dd-scroll"]});

/* 
* rdAnalysisGrid/rdAg10Script.js 
*/
function rdAgSwapFilterMode(){document.getElementById("rdAfMode_rdAgAnalysisFilter").value=="Design"?rdAfSetMode("rdAgAnalysisFilter","Simple"):rdAfSetMode("rdAgAnalysisFilter","Design")}function GetColorPicker(e,t){sColorPicker=e}function PickGaugeGoalColor(e){var t=Y.Color.toHex(Y.one("#"+e.id).getComputedStyle("backgroundColor")),n=document.getElementById("rdAgGaugeGoalsColor"+sColorPicker);n.value=t;var r=document.getElementById("rectColor"+sColorPicker);r.style.backgroundColor=t,ShowElement(this.id,"ppColors","Hide")}function rdchangeList(e,t,n,r,i,s){var o=document.getElementById(e),u;o.selectedIndex!=-1&&(u=o.options[o.selectedIndex].text),rdemptyList(e),rdfillList(e,t,n,r,u,i,s)}function rdemptyList(e){var t=document.getElementById(e);while(t.options.length)t.options[0]=null;for(var n=0;n<t.childNodes.length;n++)if(t.childNodes[n].nodeName=="optgroup"||t.childNodes[n].nodeName=="OPTGROUP")t.childNodes[n].parentNode.removeChild(t.childNodes[n]),n-=1}function rdfillList(e,t,n,r,s,o,u){if(!r||r=="")return;r.toLowerCase()=="text"||r.toLowerCase()=="date"||r.toLowerCase()=="datetime"||r.toLowerCase()=="boolean"?(t=["COUNT","DISTINCTCOUNT"],n=["Count","Distinct Count"]):(t=["SUM","AVERAGE","STDEV","COUNT","DISTINCTCOUNT","MIN","MAX"],n=["Sum","Average","Standard Deviation","Count","Distinct Count","Minimum","Maximum"]);var a=document.getElementById(e),f=t,l=n,c=null;for(i=0;i<f.length;i++){if(o[i]!=""&&o[i]){if(c==null||c.getAttribute("Label")!=o[i]){var c=document.createElement("optgroup");c.setAttribute("Label",o[i]),c.setAttribute("Class",u[i]),a.appendChild(c)}option=new Option(l[i],f[i]),option.innerHTML==""&&(option.innerHTML=l[i]),c.appendChild(option)}else option=new Option(l[i],f[i]),a.options[a.length]=option;l[i]==s&&(a.selectedIndex=i)}}YUI.add("analysis-grid",function(e){e.namespace("LogiInfo").AnalysisGrid=e.Base.create("AnalysisGrid",e.Base,[],{initializer:function(){!e.Lang.isValue(e.one("hideAgMenu"))&&e.Lang.isValue(document.getElementById("rdAgCurrentOpenPanel"))&&(location.href.indexOf("AcChartAdd")>-1||location.href.indexOf("AxAdd")>-1?this.rdAgShowMenuTab("",!0):this.rdAgShowMenuTab(document.getElementById("rdAgCurrentOpenPanel").value,!0)),!e.Lang.isValue(e.one("hideAgMenu"))&&e.Lang.isValue(document.getElementById("rdAgCurrentOpenTablePanel"))&&this.rdAgShowTableMenuTab(document.getElementById("rdAgCurrentOpenTablePanel").value,!0);var t=e.one("#rdChartError");e.Lang.isValue(t)&&this.rdAgShowChartAdd(t.get("value")),e.Lang.isValue(e.one("#rdAgDraggablePanels"))&&this.rdInitDraggableAgPanels(),document.getElementById("rdAgCurrentOpenTablePanel")&&document.getElementById("rdAgCurrentOpenTablePanel").value==""&&this.rdAgShowTableMenuTab("Layout"),document.getElementById("rdAllowCrosstabBasedOnCurrentColumns")&&document.getElementById("rdAllowCrosstabBasedOnCurrentColumns").value=="False"&&this.rdSetPanelDisabledClass("Crosstab"),rdSetUndoRedoVisibility()},rdAgShowMenuTab:function(t,n,r,i){var s=!1,o=document.getElementById("rdStartTable"),u=document.getElementById("rdAgDataColumnDetails");u.value==""&&(t="QueryBuilder",s=!0);var a=!0;if(t.length==0)a=!1;else{var f=document.getElementById("col"+t),l=document.getElementById("row"+t);f&&f.className.indexOf("rdAgSelectedTab")!=-1&&f.selectionInitialized&&(a=!1),n&&location.href.indexOf("rdAgLoadSaved")!=-1&&(a=!1)}s&&(a=!0),i&&i==1&&(a=!0);var c=!1;document.getElementById("rdAgCurrentOpenPanel").value==t&&(c=!0),document.getElementById("rdAgCurrentOpenPanel").value="";if(document.getElementById("colQueryBuilder")){if(!a||t!="QueryBuilder")this.rdSetClassNameById("colQueryBuilder","rdAgUnselectedTab"),this.rdSetDisplayById("rowQueryBuilder","none");document.getElementById("colQueryBuilder").selectionInitialized=!0}if(document.getElementById("colCalc")){if(!a||t!="Calc")this.rdSetClassNameById("colCalc","rdAgUnselectedTab"),this.rdSetDisplayById("rowCalc","none");document.getElementById("colCalc").selectionInitialized=!0}if(document.getElementById("colFilter")){if(!a||t!="Filter")this.rdSetClassNameById("colFilter","rdAgUnselectedTab"),this.rdSetDisplayById("rowFilter","none");document.getElementById("colFilter").selectionInitialized=!0}a&&(document.getElementById("rdAgCurrentOpenPanel").value=t,f&&(f.className="rdAgSelectedTab"),l&&(l.style.display=""),!n&&l&&l.firstChild&&!c&&rdFadeElementIn(l.firstChild,400)),this.rdSetMenuClasses(s);var h=0,p="";while(document.getElementById("iclQbColumns"+h)!=null){var d=rdGetInputValues(document.getElementById("iclQbColumns"+h));d=decodeURIComponent(d.substring(d.lastIndexOf("=")+1)),p+=d,h+=1}p==""&&h>0&&this.rdSetMenuClasses(!0),typeof window.rdRepositionSliders!="undefined"&&rdRepositionSliders(),t=="Filter"&&typeof r!="undefined"&&(e.one("#rdAfFilterColumnID_rdAgAnalysisFilter").get("options").each(function(){var e=this.get("value");e==r&&this.set("selected",!0)}),document.getElementById("rdAfMode_rdAgAnalysisFilter").value=="Design"?rdAfUpdateEditControls("rdAgAnalysisFilter"):(document.getElementById("rdAfMode_rdAgAnalysisFilter").value="Design",rdAfUpdateUi(!0,"rdAgAnalysisFilter","Design")),e.one("#rowsAnalysisGrid").scrollIntoView())},rdSetMenuClasses:function(e){this.rdSetPanelModifiedClass("QueryBuilder"),this.rdSetPanelModifiedClass("Calc"),this.rdSetPanelModifiedClass("Filter"),this.rdSetPanelModifiedClass("TableEdit"),e&&(this.rdSetPanelDisabledClass("Calc"),this.rdSetPanelDisabledClass("Filter"),this.rdSetPanelDisabledClass("TableEdit"),this.rdSetPanelDisabledClass("Chart"),this.rdSetPanelDisabledClass("Crosstab"))},rdAgToggleTablePanel:function(e){var t=rdGetCookie("rdPanelExpanded_Table");e||(t!="True"?(t="True",rdSetCookie("rdPanelExpanded_Table","True")):(t="False",rdSetCookie("rdPanelExpanded_Table","False")));if(t!="False"){var n=document.getElementById("divPanelClosed_Table");n&&(n.style.display="none");var r=document.getElementById("divPanelOpen_Table");r&&(r.style.display="");var i=document.getElementById("rowContentTable");i&&(i.style.display="");var s=document.getElementById("rowsTableMenuOptions");s&&(s.style.display="");var o=document.getElementById("rowTableControls");o&&(o.style.display="");var u=document.getElementById("colAddToDashboardDataTable");u&&(u.style.display="");var a=document.getElementById("colTableMenu");a&&(a.style.display="");var f=document.getElementById("colTableExportControls");f&&(f.style.display="");var f=document.getElementById("colAddToDashboardDataTable");f&&(f.style.display="")}else{var n=document.getElementById("divPanelClosed_Table");n&&(n.style.display="");var r=document.getElementById("divPanelOpen_Table");r&&(r.style.display="none");var i=document.getElementById("rowContentTable");i&&(i.style.display="none");var s=document.getElementById("rowsTableMenuOptions");s&&(s.style.display="none");var o=document.getElementById("rowTableControls");o&&(o.style.display="none");var u=document.getElementById("colAddToDashboardDataTable");u&&(u.style.display="none");var l=document.getElementById("colTableMenu");l&&(l.style.display="none");var f=document.getElementById("colTableExportControls");f&&(f.style.display="none")}typeof window.rdRepositionSliders!="undefined"&&rdRepositionSliders(),e||this.rdSavePanelState("Table",t)},rdAgToggleCrosstabPanel:function(e,t){var n=rdGetCookie("rdPanelExpanded_"+e);t||(n!="True"?(n="True",rdSetCookie("rdPanelExpanded_"+e,"True")):(n="False",rdSetCookie("rdPanelExpanded_"+e,"False")));if(n=="True"){var r=document.getElementById("divPanelClosed_"+e);r&&(r.style.display="none");var i=document.getElementById("divPanelOpen_"+e);i&&(i.style.display="");var s=document.getElementById("rowContentAnalCrosstab_"+e);s&&(s.style.display="");var o=document.getElementById("colAnalCrosstabAddDashboard_"+e);o&&(o.style.display="");var u=document.getElementById("colCrosstabExportControls_"+e);u&&(u.style.display="");var a=document.getElementById("colAxEdit_"+e);a&&(a.style.display="")}else{var r=document.getElementById("divPanelClosed_"+e);r&&(r.style.display="");var i=document.getElementById("divPanelOpen_"+e);i&&(i.style.display="none");var s=document.getElementById("rowContentAnalCrosstab_"+e);s&&(s.style.display="none");var o=document.getElementById("colAnalCrosstabAddDashboard_"+e);o&&(o.style.display="none");var u=document.getElementById("colCrosstabExportControls_"+e);u&&(u.style.display="none");var a=document.getElementById("colAxEdit_"+e);a&&(a.style.display="none")}if(!document.getElementById("cellAxCrosstab_"+e)){var o=document.getElementById("colAnalCrosstabAddDashboard_"+e);o&&(o.style.display="none");var u=document.getElementById("colCrosstabExportControls_"+e);u&&(u.style.display="none")}typeof window.rdRepositionSliders!="undefined"&&rdRepositionSliders(),t||this.rdSavePanelState(e,n)},rdAgGetColumnList:function(e,t,n,r,i,s){var o=document.getElementById("rdAgDataColumnDetails");if(o.value!=""){var u=o.value,a=u.split(",");if(a.length>0){var f,l=0,c="";for(f=0;f<a.length;f++){var h=a[f];s==0&&h.indexOf("^")>-1&&(h="");if(h.length>1&&h.indexOf(":")>-1){var p=h.split(":")[1].split("|")[0];n==""?(c=h.split(":")[0],e[f]=c.split(";")[0],t[f]=c.split(";")[1],f==1&&(e[0]="",t[0]=""),h.indexOf("|")>-1?(r[f]=h.split("|")[1].split("-")[0],h.indexOf("^")>-1?i[f]=h.split("-")[1].split("^")[0]:i[f]=h.split("|")[1].split("-")[1]):(r[f]="",i[f]="")):n=="number"&&p=="Number"&&(c=h.split(":")[0],e[l]=c.split(";")[0],t[l]=c.split(";")[1],l++,h.indexOf("|")>-1?(r[l]=h.split("|")[1].split("-")[0],i[l]=h.split("|")[1].split("-")[1]):(r[l]="",i[l]=""))}}n=="number"&&(e.unshift(""),t.unshift(""))}}},rdAgGetColumnDataType:function(e){var t=document.getElementById("rdAgDataColumnDetails");if(t.value!=""){var n=t.value,r=n.split(",");if(r.length>0){var i;for(i=0;i<r.length;i++){var s=r[i];if(s.length>1&&s.indexOf(":")>-1){var o=s.split(":")[0];o=o.split(";")[0];if(o==e)return s.split(":")[1].split("|")[0]}}}}},rdAgToggleChartPanel:function(e,t){var n=rdGetCookie("rdPanelExpanded_"+e);t||(n!="True"?(n="True",rdSetCookie("rdPanelExpanded_"+e,"True")):(n="False",rdSetCookie("rdPanelExpanded_"+e,"False")));if(n=="True"){var r=document.getElementById("divPanelClosed_"+e);r&&(r.style.display="none");var i=document.getElementById("divPanelOpen_"+e);i&&(i.style.display="");var s=document.getElementById("rowContentAnalChart_"+e);s&&(s.style.display="");var o=document.getElementById("colAnalChartAddDashboard_"+e);o&&(o.style.display="");var u=document.getElementById("colAcEdit_"+e);u&&(u.style.display="")}else{var r=document.getElementById("divPanelClosed_"+e);r&&(r.style.display="");var i=document.getElementById("divPanelOpen_"+e);i&&(i.style.display="none");var s=document.getElementById("rowContentAnalChart_"+e);s&&(s.style.display="none");var o=document.getElementById("colAnalChartAddDashboard_"+e);o&&(o.style.display="none");var u=document.getElementById("colAcEdit_"+e);u&&(u.style.display="none")}if(!document.getElementById("rdAcChart_"+e)){var o=document.getElementById("colAnalChartAddDashboard_"+e);o&&(o.style.display="none")}typeof window.rdRepositionSliders!="undefined"&&rdRepositionSliders(),t||this.rdSavePanelState(e,n)},rdSavePanelState:function(e,t){var n="&rdReport="+document.getElementById("rdAgReportId").value;n+="&rdAgPanelID="+e,n+="&rdAgId="+document.getElementById("rdAgId").value,n+="&rdAgPanelEpanded="+t,rdAjaxRequestWithFormVars("rdAjaxCommand=rdAjaxNotify&rdNotifyCommand=UpdateAgPanelState"+n)},rdChangeAggregateOptions:function(){var e=[],t=[],n=[],r=[];this.rdAgGetColumnList(e,t,"",n,r,!1);var i=document.getElementById("rdAgAggrColumn"),s=i.options[i.selectedIndex].value,o=this.rdAgGetColumnDataType(s);s==""&&(o="all"),rdchangeList("rdAgAggrFunction",e,t,o,"","")},rdAgTableTogglePanelMenu:function(e){var t=rdGetCookie("rdTablePanelMenuExpanded");e||(t!="True"?(t="True",rdSetCookie("rdTablePanelMenuExpanded","True")):(t="False",rdSetCookie("rdTablePanelMenuExpanded","False")));if(t=="False"){var n=document.getElementById("rowTableMenu");n&&(n.style.display="none")}else{var n=document.getElementById("rowTableMenu");n&&(n.style.display="")}typeof window.rdRepositionSliders!="undefined"&&rdRepositionSliders()},rdAgChartTogglePanelMenu:function(e,t){var n=rdGetCookie("rdChartPanelMenuExpanded_"+e);t||(n!="True"?(n="True",rdSetCookie("rdChartPanelMenuExpanded_"+e,"True")):(n="False",rdSetCookie("rdChartPanelMenuExpanded_"+e,"False")));if(n=="False"){var r=document.getElementById("divAcChartTypes_"+e);r&&(r.style.display="none");var i=document.getElementById("divChartLists_"+e);i&&(i.style.display="none");var s=document.getElementById("divAcControls_"+e);s&&(s.style.display="none")}else{var r=document.getElementById("divAcChartTypes_"+e);r&&(r.style.display="");var i=document.getElementById("divChartLists_"+e);i&&(i.style.display="");var s=document.getElementById("divAcControls_"+e);s&&(s.style.display="")}typeof window.rdRepositionSliders!="undefined"&&rdRepositionSliders()},rdAgCrosstabTogglePanelMenu:function(e,t){var n=rdGetCookie("rdCrosstabPanelMenuExpanded_"+e);t||(n!="True"?(n="True",rdSetCookie("rdCrosstabPanelMenuExpanded_"+e,"True")):(n="False",rdSetCookie("rdCrosstabPanelMenuExpanded_"+e,"False")));if(n=="False"){var r=document.getElementById("divAxControls_"+e);r&&(r.style.display="none")}else{var r=document.getElementById("divAxControls_"+e);r&&(r.style.display="");var i=document.getElementById("divAxEditSelected_"+e);i&&(i.style.display="");var s=document.getElementById("divAxEditUnselected_"+e);s&&(s.style.display="none")}typeof window.rdRepositionSliders!="undefined"&&rdRepositionSliders()},rdAgShowTableMenuTab:function(e,t,n){var r=!1,i=!0;e=e.replace(/,/g,"");if(e.length==0)i=!1;else{var s=document.getElementById("lblHeading"+e),o=document.getElementById("row"+e);s&&s.className.indexOf("rdAgCommandHighlight")!=-1&&(i=!1),t&&location.href.indexOf("rdAgLoadSaved")!=-1&&(i=!1)}r&&(i=!0),document.getElementById("rdAgCurrentOpenTablePanel").value="",this.rdSetClassNameById("lblHeadingGroup","rdAgCommandIdle"),this.rdSetClassNameById("lblHeadingAggr","rdAgCommandIdle"),this.rdSetClassNameById("lblHeadingPaging","rdAgCommandIdle"),this.rdSetClassNameById("lblHeadingSortOrder","rdAgCommandIdle"),this.rdSetClassNameById("lblHeadingLayout","rdAgCommandIdle"),this.rdSetDisplayById("rowLayout","none"),this.rdSetDisplayById("rowSortOrder","none"),this.rdSetDisplayById("rowGroup","none"),this.rdSetDisplayById("rowAggr","none"),this.rdSetDisplayById("rowPaging","none"),i&&s&&(document.getElementById("rdAgCurrentOpenTablePanel").value=e,s.className="rdAgCommandHighlight",o&&(o.style.display=""),!t&&o&&o.firstChild&&rdFadeElementIn(o.firstChild,400)),e=="Group"&&this.rdAgGetGroupByDateOperatorDiv()},rdSetClassNameById:function(e,t){var n=document.getElementById(e);n&&(n.className=t)},rdSetDisplayById:function(e,t){var n=document.getElementById(e);n&&(n.style.display=t)},rdSetPanelModifiedClass:function(t){var n=e.one("#col"+t);e.Lang.isValue(n)&&n.one("table").hasClass("rdHighlightOn")&&(n._node.style.fontWeight="bold")},rdSetPanelDisabledClass:function(t){var n=e.one("#col"+t);n!=null&&n.addClass("rdAgDisabledTab")},rdAgGetGroupByDateOperatorDiv:function(){document.rdForm.rdAgPickDateColumnsForGrouping.value.indexOf(document.rdForm.rdAgGroupColumn.value+",")!=-1&&document.rdForm.rdAgGroupColumn.value.length!=0?e.Lang.isValue(e.one("#divGroupByDateOperator"))&&ShowElement(this.id,"divGroupByDateOperator","Show"):e.Lang.isValue(e.one("#divGroupByDateOperator"))&&(ShowElement(this.id,"divGroupByDateOperator","Hide"),document.rdForm.rdAgDateGroupBy.value="")},rdInitDraggableAgPanels:function(){var t=!1,n=document.getElementById("rdAgDraggablePanels");n!=null&&(t=!0);var r=this.rdGetDraggableAgPanels();for(i=0;i<r.length;i++)e.DD.DDM.getNode(r[i]).destroy();if(r.length>1)for(var i=0;i<r.length;i++){var s=r[i];if(t){var o=e.one("#"+s.id),u=new e.DD.Drag({node:o}),a=o.plug(e.Plugin.Drop);o.addClass("dragHandleOnly");var f=null,l=[0,0],c=!1;u.on("drag:start",this.Panel_onDragStart,this),u.on("drag:drag",this.Panel_onDrag,this),u.on("drag:over",this.Panel_onDragOver,this),u.on("drag:drophit",this.Panel_onDropHit,this),u.on("drag:end",this.Panel_onDragEnd,this);var h=e.Selector.query("table.rdAgContentHeadingRow",s).length==0?e.Selector.query("td.rdAgContentHeading",s)[0].id:e.Selector.query("table.rdAgContentHeadingRow",s)[0].id,p=e.one("#"+h);u.addHandle("#"+h).plug(e.Plugin.DDWinScroll,{horizontal:!1,vertical:!0,scrollDelay:100,windowScroll:!0}),p.setStyle("cursor","move")}}},Panel_onDragStart:function(t){pnlDragged=t.target.get("dragNode").getDOMNode(),this.rdSetDraggableAgPanelsZIndex(pnlDragged,t.target.panels),e.DOM.setStyle(pnlDragged,"opacity",".65"),originalPanelPosition=e.DOM.getXY(pnlDragged),bDoNothingMore=!1,this.set("targetPanel",null)},Panel_onDragOver:function(t){this.set("targetPanel",t.drop.get("node").getDOMNode());var n=this.get("targetPanel");pnlDragged=t.target.get("dragNode").getDOMNode();if(n.id.match("rdDivAgPanelWrap_")){var r=e.DOM.region(pnlDragged),i=e.DOM.region(n),s=i.height;eleTargetPanelHandle=n.nextSibling,originalPanelPosition[1]<r.top?r.top>i.top+Math.round(s/2)?n.nextSibling.firstChild.firstChild.firstChild.className="rdAgDropZoneActive":n.previousSibling.firstChild.firstChild.firstChild.className="rdAgDropZoneActive":r.top<i.top+Math.round(s/2)?n.previousSibling.firstChild.firstChild.firstChild.className="rdAgDropZoneActive":n.nextSibling.firstChild.firstChild.firstChild.className="rdAgDropZoneActive"}},Panel_onDrag:function(t){this.rdNeutralizeDropZoneColor();var n=this.get("targetPanel");e.Lang.isValue(n)||(pnlDragged.previousSibling.firstChild.firstChild.firstChild.className="rdAgDropZoneActive")},Panel_onDropHit:function(t){this.rdMoveAgPanels(pnlDragged,this.get("targetPanel"),originalPanelPosition,bDoNothingMore),pnlDragged.style.cssText="",e.DOM.setStyle(pnlDragged,"opacity","1"),bDoNothingMore=!0},Panel_onDragEnd:function(t){var n=this;this.rdMoveAgPanels(pnlDragged,this.get("targetPanel"),originalPanelPosition,bDoNothingMore),pnlDragged.style.cssText="",e.DOM.setStyle(pnlDragged,"opacity","1"),LogiXML.features.touch&&setTimeout(function(){n.rdResetAGPanelAfterDDScroll(pnlDragged)},1e3)},rdMoveAgPanels:function(t,n,r,i){if(!i){var s=e.DOM.region(t),o=t.nextSibling;if(n){var u=e.DOM.region(n),a=u.height,f=n.nextSibling;n.id.match("rdDivAgPanelWrap_")&&(r[1]<s.top?(s.top>u.top+Math.round(a/2)?f.nextSibling?(n.parentNode.insertBefore(t,f.nextSibling),n.parentNode.insertBefore(o,f.nextSibling.nextSibling)):(n.parentNode.appendChild(t),n.parentNode.appendChild(o)):(n.parentNode.insertBefore(t,n),n.parentNode.insertBefore(o,n)),this.rdSaveDraggableAgPanelPositions()):(s.top<u.top+Math.round(a/2)?(n.parentNode.insertBefore(t,n),n.parentNode.insertBefore(o,n)):f.nextSibling?(n.parentNode.insertBefore(t,f.nextSibling),n.parentNode.insertBefore(o,f.nextSibling.nextSibling)):(n.parentNode.appendChild(t),n.parentNode.appendChild(o)),this.rdSaveDraggableAgPanelPositions()))}else{var l=this.rdGetDraggableAgPanels(),s=e.DOM.region(t);r[1]<s.top?t.id!=l[l.length-1].id&&s.top>e.DOM.region(l[l.length-1]).bottom&&(l[0].parentNode.appendChild(t),l[0].parentNode.appendChild(o),this.rdSaveDraggableAgPanelPositions()):t.id!=l[0].id&&s.top<e.DOM.region(l[0]).top&&(l[0].parentNode.insertBefore(t,l[0]),l[0].parentNode.insertBefore(o,l[0]),this.rdSaveDraggableAgPanelPositions())}this.rdNeutralizeDropZoneColor(),t.style.top="0px",t.style.left="0px"}},rdSaveDraggableAgPanelPositions:function(){var e="&rdReport="+document.getElementById("rdAgReportId").value;e+="&rdAgPanelOrder=";var t=this.rdGetDraggableAgPanels();for(var n=0;n<t.length;n++){var r=t[n];e.indexOf(r.id.replace("rdDivAgPanelWrap_","")+",")<0&&(e+=r.id.replace("rdDivAgPanelWrap_","")+",")}e+="&rdAgId="+document.getElementById("rdAgId").value,window.status="Saving dashboard panel positions.",rdAjaxRequestWithFormVars("rdAjaxCommand=rdAjaxNotify&rdNotifyCommand=UpdateAgPanelOrder"+e)},rdGetDraggableAgPanels:function(){var t=new Array,n=document.getElementById("rdDivAgPanels");if(n==null)return t;var r=n.getElementsByTagName("div");for(i=0;i<r.length;i++){var s=r[i];if(s.id&&s.id.indexOf("rowMenu")<0&&s.id.indexOf("rowTitle")<0&&s.id.indexOf("rdDivAgPanelWrap_row")>-1)if(e.Lang.isValue(s.firstChild.firstChild))s.firstChild.firstChild.firstChild.style.display!="none"&&t.push(s);else{var o=e.one(s).getDOMNode(),u=o.previousSibling;o.parentNode.removeChild(o),u.parentNode.removeChild(u),s=e.one("#"+s.id).getDOMNode(),t.push(s)}}return t},rdSetDraggableAgPanelsZIndex:function(t,n){n=this.rdGetDraggableAgPanels();for(var r=0;r<n.length;r++){var i=n[r];i.id==t.id?e.DOM.setStyle(i,"zIndex",1e3):e.DOM.setStyle(i,"zIndex",0)}},rdResetAGPanelAfterDDScroll:function(t){var n=e.one(t);n.setStyles({left:0,top:0})},rdNeutralizeDropZoneColor:function(){var t=e.Selector.query("td.rdAgDropZoneActive",e.DOM.byId("rdDivAgPanels"));for(var n=0;n<t.length;n++){var r=t[n];r.className="rdAgDropZone"}}},{NAME:"analysisgrid",ATTRS:{targetPanel:{value:null}},rdSaveColumnWidths:function(){if(!LogiXML||!LogiXML.ResizableColumns||!LogiXML.ResizableColumns.getWidths||!document.rdForm)return;var e=document.getElementsByName("rdColumnWidths");e&&e.length>0?e=e[0]:(e=document.createElement("input"),e.type="hidden",e.name="rdColumnWidths",document.rdForm.appendChild(e));var t=LogiXML.ResizableColumns.getWidths();e.value=JSON.stringify(t)}})},"1.0.0",{requires:["dd-drop-plugin","dd-plugin","dd-scroll","dd-constrain"]});var sColorPicker="1";

/* 
* rdElementSeeker/rdElementSeeker.js 
*/
YUI.add("element-seeker",function(e){e.namespace("LogiInfo").ElementSeeker=e.Base.create("ElementSeeker",e.Base,[],{HOVER_CLASS:"studioElementSeekerHover",initializer:function(){this.rdIdeIdx=null,this.active=!1,this.listeners=null,this.ons=null,this.boundHover=null,this.boundClick=null,this.highlighterWidth=1,this.highlighterTop=document.createElement("div"),this.highlighterTop.style.display="none",this.highlighterTop.style.width="0",this.highlighterTop.style.height=this.highlighterWidth+"px",this.highlighterTop.style.position="absolute",this.highlighterTop.style.zIndex=9999,this.highlighterTop.className=this.HOVER_CLASS,this.highlighterRight=document.createElement("div"),this.highlighterRight.style.display="none",this.highlighterRight.style.width=this.highlighterWidth+"px",this.highlighterRight.style.height="0",this.highlighterRight.style.position="absolute",this.highlighterRight.style.zIndex=9999,this.highlighterRight.className=this.HOVER_CLASS,this.highlighterBottom=document.createElement("div"),this.highlighterBottom.style.display="none",this.highlighterBottom.style.width="0",this.highlighterBottom.style.height=this.highlighterWidth+"px",this.highlighterBottom.style.position="absolute",this.highlighterBottom.style.zIndex=9999,this.highlighterBottom.className=this.HOVER_CLASS,this.highlighterLeft=document.createElement("div"),this.highlighterLeft.style.display="none",this.highlighterLeft.style.width=this.highlighterWidth+"px",this.highlighterLeft.style.height="0",this.highlighterLeft.style.position="absolute",this.highlighterLeft.style.zIndex=9999,this.highlighterLeft.className=this.HOVER_CLASS,document.body.appendChild(this.highlighterTop),document.body.appendChild(this.highlighterRight),document.body.appendChild(this.highlighterBottom),document.body.appendChild(this.highlighterLeft),this.sendStudioMessageDirect("Ping")},showIcon:function(){var e=document.getElementsByClassName("rdElementSeekerImage"),t;for(var n=0;n<e.length;n++)t=e[n],t.style.display=""},stopBubble:function(e){return e=e||window.event,e?(e.cancelBubble=!0,e.stopPropagation&&e.stopPropagation(),e.preventDefault&&e.preventDefault(),!1):!1},activate:function(e,t){if(t!==!0&&window.parent&&window.parent!==window.self&&window.parent.LogiXML&&window.parent.LogiXML.ElementSeeker)return window.parent.LogiXML.ElementSeeker.activate(e);if(this.active)return!1;this.listeners=[],this.ons=[];var n=this.hover.bind(this),r=this.click.bind(this);this.boundHover=n,this.boundClick=r;var i=function(e){e.addEventListener?(e.addEventListener("mouseover",n),e.addEventListener("click",r)):(e.attachEvent("onmouseover",n),e.attachEvent("onclick",r)),this.listeners.push(e)}.bind(this),s=function(e){var t,n,r=!1;for(var i=e.attributes.length-1;i>=0;i--)t=e.attributes[i],t.name.toLowerCase().indexOf("on")===0&&(e.setAttribute("rdOrigOns_"+t.name,t.value),e.removeAttribute(t.name),r=!0);r&&this.ons.push(e);for(var i=0;i<e.childNodes.length;i++){var o=e.childNodes[i];o.tagName&&s(o)}}.bind(this);for(var o=0;o<document.body.childNodes.length;o++){var u=document.body.childNodes[o];u.tagName&&(s(u),i(u))}rdAddCssClass(document.body,"elementSeekerCursor"),rdAddCssClass(document.body.parentNode,"elementSeekerCursor");var a=document.getElementsByTagName("iframe");for(var o=0;o<a.length;o++){var f=a[o].contentWindow.LogiXML;f&&f.ElementSeeker&&f.ElementSeeker.activate(e,!0)}var l=[".rdChartCanvas","table[id^=rdPopupPanelTable_popupEditAgViz]"];for(var c=0;c<l.length;c++){var h=document.querySelectorAll(l[c]);for(var o=0;o<h.length;o++){var p=h[o],d=p.ownerDocument.createElement("div");p.tagName.toLowerCase()=="table"&&(d=p.ownerDocument.createElement("thead"));var v=p.getBoundingClientRect();d.className="es-overflow-wrapper",d.style.top="0px",d.style.left="0px",d.style.position="absolute",d.style.zIndex="9999",d.style.width=v.width+"px",d.style.height=v.height+"px",p.appendChild(d),i(d)}}return this.setImageActive(!0),this.active=!0,this.stopBubble(e)},setImageActive:function(e){var t=document.getElementsByClassName("rdElementSeekerImage"),n,r;e=e?!0:!1;for(var i=0;i<t.length;i++){n=t[i],n.src=n.src.replace("Hover","");var s=n.src.lastIndexOf(".");s<0?r=n.src.toLowerCase().indexOf("active")===n.src.length-6:r=s>=6&&n.src.substr(s-6,6).toLowerCase()==="active";if(r==e)continue;e?(n.title="Click in a highlighted region.",s<0?n.src=n.src+"Active":s==0?n.src="Active"+n.src:n.src=n.src.substr(0,s)+"Active"+n.src.substr(s)):(n.title="Seek an element in Logi Studio.",s<0?n.src=n.src.substr(0,n.src.length-6):s==6?n.src=n.src.substr(s):n.src=n.src.substr(0,s-6)+n.src.substr(s))}},cancel:function(e){if(e!==!0&&window.parent&&window.parent!==window.self&&window.parent.LogiXML&&window.parent.LogiXML.ElementSeeker)return window.parent.LogiXML.ElementSeeker.cancel();this.clear();if(!this.active)return;if(this.ons){var t;for(var n=0;n<this.ons.length;n++){t=this.ons[n];for(var r=t.attributes.length-1;r>=0;r--)attr=t.attributes[r],attr.name.length>10&&attr.name.toLowerCase().indexOf("rdorigons_")===0&&(t.setAttribute(attr.name.substr(10),attr.value),t.removeAttribute(attr.name))}this.ons=null}if(this.listeners){var t,i=this.boundHover,s=this.boundClick;for(var n=0;n<this.listeners.length;n++)t=this.listeners[n],t.removeEventListener?(t.removeEventListener("mouseover",i),t.removeEventListener("click",s)):(t.detachEvent("onmouseover",i),t.detachEvent("onclick",s));this.listeners=null}var o=document.getElementsByClassName(this.HOVER_CLASS);for(var n=0;n<o.length;n++)o[n].style.display="none";rdRemoveCssClass(document.body,"elementSeekerCursor"),rdRemoveCssClass(document.body.parentNode,"elementSeekerCursor");var u=document.getElementsByTagName("iframe");for(var n=0;n<u.length;n++){var a=u[n].contentWindow.LogiXML;a&&a.ElementSeeker&&a.ElementSeeker.cancel(!0)}var f=document.getElementsByClassName("es-overflow-wrapper");while(f[0])f[0].parentNode.removeChild(f[0]);this.setImageActive(!1),this.active=!1},clear:function(){},hover:function(e){e=e||window.event;var t=e.target;while(t){if(t.getAttribute&&t.getAttribute("rdIdeIdx")){this.setActiveElement(t);break}t=t.parentNode}return this.stopBubble(e)},setActiveElement:function(e){this.clear();var t=e;t.tagName.indexOf("RDCONDELEMENT")!=-1&&(t=t.firstChild.firstChild),t.firstChild&&t.firstChild.tagName=="RDINTERACTIVEPAGING"&&(t=t.firstChild.firstChild),console.log(t.tagName);var n=t.getBoundingClientRect(),r=n.right-n.left,i=n.bottom-n.top,s=n.top,o=n.left,u=e.offsetElement||document.body;while(u){if(u===document.body){s+=document.body.scrollTop+document.body.parentNode.scrollTop,o+=document.body.scrollLeft+document.body.parentNode.scrollLeft;break}s+=u.scrollTop,o+=u.scrollLeft,u=u.offsetParent}this.rdIdeIdx=e.getAttribute("rdIdeIdx"),this.highlighterTop.style.width=r+"px",this.highlighterTop.style.top=s+"px",this.highlighterTop.style.left=o+"px",this.highlighterTop.style.display="block",this.highlighterRight.style.height=i+"px",this.highlighterRight.style.top=s+"px",this.highlighterRight.style.left=o+r-this.highlighterWidth+"px",this.highlighterRight.style.display="block",this.highlighterBottom.style.width=r+"px",this.highlighterBottom.style.top=s+i-this.highlighterWidth+"px",this.highlighterBottom.style.left=o+"px",this.highlighterBottom.style.display="block",this.highlighterLeft.style.height=i+"px",this.highlighterLeft.style.top=s+"px",this.highlighterLeft.style.left=o+"px",this.highlighterLeft.style.display="block"},click:function(e){e=e||window.event;var t=e.target;return!t||t.id==="rdElementSeeker_Image"?this.stopBubble(e):(this.cancel(),this.sendStudioMessageDirect("Seek"),this.rdIdeIdx=null,this.stopBubble(e))},sendStudioMessageDirect:function(t){var n;switch(t){case"Seek":n=this.rdIdeIdx;break;case"Ping":n="0";break;default:return}if(n===null)return;var r=rdAjaxGetUrlParameter(location.href.toString(),"rdReport"),i=rdAjaxGetUrlParameter(location.href.toString(),"rdMobile"),s=window.document.implementation.createDocument("","",null),o=s.createElement("ServerMessage"),u=document.getElementsByName("rdParentReport")[0];u&&(r=u.value),o.setAttribute("ReportID",r||""),o.setAttribute("rdIdeIdx",n),o.setAttribute("Type",t),i&&o.setAttribute("IsMobileReport",i),s.appendChild(o);var a=(new XMLSerializer).serializeToString(s),f=document.getElementById("rdElementSeekerUrl").value;try{e.io(f,{method:"POST",data:a,headers:{"Content-Type":"text/plain"},on:t=="Seek"?{success:function(){console.log("Element Locator message sent successfully to Logi Studio")},failure:function(){console.log("Failed to send Element Locator message to Logi Studio")}}:{success:this.showIcon,failure:function(){console.log("Studio is not listening. Element Seeker disabled.")}}})}catch(l){console.log(l)}}},{NAME:"elementseeker",ATTRS:{}})},"1.0.0",{requires:[]});
