        ...
        for (y=1; y<=3; y=y+1){
            ...
            for(x=1; x<=31; x=x+1){
                (function(x)
                {
                    ...
                    if(sElement != null){                     
                        var url = sElement.lastChild.href.substring(sElement.lastChild.href.lastIndexOf('javascript')+11, sElement.lastChild.href.indexOf(')')+1);
                        sElement.lastChild.href = 'javascript:void 0';                       
                        sElement.onclick = function() { eval(unescape(url)); }  // Used unescape() to make it work for Safari #12103.
                    }
                })(x);
            }
        }
